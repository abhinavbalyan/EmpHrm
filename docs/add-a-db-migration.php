...
<div id="inner-wrap" class="wrap hfeed kt-clear">
            ...
            <div id="betterdocs-single-main" class="docs-single-main">
                    ...
                    <div class="docs-single-title">
                        <nav id="betterdocs-breadcrumb" class="betterdocs-breadcrumb" xmlns:v="http://rdf.data-vocabulary.org/#">
                            <ul class="betterdocs-breadcrumb-list">
                                ...
                                <li class="betterdocs-breadcrumb-item item-current item-1210 current"><span>Add a DB Migration</span></li>
                            </ul>
                        </nav>
                        <h1 id="betterdocs-entry-title" class="betterdocs-entry-title">Add a DB Migration</h1>
                    </div>
                </header>
                <div class="betterdocs-entry-content">
                        ...
                        <ul class="toc-list betterdocs-hierarchial-toc">
                            <li class="betterdocs-toc-heading-level-1"><a href="#introduction">Introduction</a>
                                <ul class="betterdocs-toc-list-level-2">
                                    <li class="betterdocs-toc-heading-level-2"><a href="#add-a-simple-migration">Add a Simple Migration</a>
                                        <ul class="betterdocs-toc-list-level-3">
                                            <li class="betterdocs-toc-heading-level-3"><a href="#migration.php">Migration.php</a></li>
                                        </ul>
                                    </li>
                                    <li class="betterdocs-toc-heading-level-2"><a href="#execute-migration-when-installing-the-extension">Execute Migration when Installing the Extension</a></li>
                                    <li class="betterdocs-toc-heading-level-2"><a href="#update-extension-include-file">Update Extension Include File</a>
                                        <ul class="betterdocs-toc-list-level-3">
                    ...
                    <div id="betterdocs-single-content" class="betterdocs-content">
                        <p>Here we will show you how to add a database migration.</p>
                        <h1 id="introduction" class="betterdocs-content-heading" id="introduction">Introduction <a href="#introduction" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/add-a-db-migration/#introduction" data-title="Copy URL">#</a></h1>
                        <p>When your extension is installed on an IceHrm installation, you can make changes o the IceHrm database using Migrations.</p>
                        <h2 id="add-a-simple-migration" class="betterdocs-content-heading" id="add-a-simple-migration">Add a Simple Migration <a href="#add-a-simple-migration" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/add-a-db-migration/#add-a-simple-migration" data-title="Copy URL">#</a></h2>
                        <p>This extension will manage tasks. So we might have to make changes to the database. For that, we should add a migration. We can use the core migration classes offered by Icehrm.</p>
 ...
 ┃ ┗ 📜tasks.php
 ┗</code></pre>
                        <h3 id="migration.php" class="betterdocs-content-heading" id="migration.php">Migration.php <a href="#migration.php" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/add-a-db-migration/#migration.php" data-title="Copy URL">#</a></h3>
...
SQL;
        return $this->executeQuery($sql);
                        ...
                        <p>This migration will create a table named Tasks in IceHrm database. The migration will be executed only the first time the extension is enabled. If you are making changes to the migration you need to make sure it gets applied manually.</p>
                        <h2 id="execute-migration-when-installing-the-extension" class="betterdocs-content-heading" id="execute-migration-when-installing-the-extension">Execute Migration when Installing the Extension <a href="#execute-migration-when-installing-the-extension" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/add-a-db-migration/#execute-migration-when-installing-the-extension" data-title="Copy URL">#</a></h2>
                        <p>For this, we should update the Extension.php a bit to execute the migration when the extension is activated for the first time.</p>
                        <pre class="wp-block-code"><code>&lt;?php
namespace Tasks;
...
class Extension extends IceExtension
{
    ...
    public function setupRestEndPoints()
    {
                        ...
                        <h2 id="update-extension-include-file" class="betterdocs-content-heading" id="update-extension-include-file">Update Extension Include File <a href="#update-extension-include-file" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/add-a-db-migration/#update-extension-include-file" data-title="Copy URL">#</a></h2>
                        <h3 id="tasks.php" class="betterdocs-content-heading" id="tasks.php">tasks.php <a href="#tasks.php" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/add-a-db-migration/#tasks.php" data-title="Copy URL">#</a></h3>
                        <pre class="wp-block-code"><code>&lt;?php

require_once __DIR__.'/src/Tasks/Extension.php';
require_once __DIR__.'/src/Tasks/Migration.php';</code></pre>
                        <p>Since the extension is already active the migration will not get executed. Because of this, we need to remove it from the Modules table manually.</p>
                        <pre class="wp-block-code"><code>$> DELETE from Modules where name = 'tasks' and mod_group = 'extension';</code></pre>
                        <p>Now reload the page and you will be able to see the new Tasks table in your IceHrm database.</p>
                    </div>
                </div>
                ...
                <div class="docs-navigation"><a href="https://icehrm.com/explore/docs/creating-first-extension/" rel="prev"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
                        ...
                        </svg> Creating First Extension</a><a href="https://icehrm.com/explore/docs/adding-entries-to-db/" rel="next">Adding Entries to DB <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
