            ...
            <div id="betterdocs-single-main" class="docs-single-main">
                    ...
                    <div class="docs-single-title">
                        <nav id="betterdocs-breadcrumb" class="betterdocs-breadcrumb" xmlns:v="http://rdf.data-vocabulary.org/#">
                            <ul class="betterdocs-breadcrumb-list">
                                ...
                                <li class="betterdocs-breadcrumb-item item-current item-2577 current"><span>Recording Attendance</span></li>
                            </ul>
                        </nav>
                        <h1 id="betterdocs-entry-title" class="betterdocs-entry-title">Recording Attendance</h1>
                    </div>
                </header>
                <div class="betterdocs-entry-content">
                    ...
                    <div id="betterdocs-single-content" class="betterdocs-content">
                        ...
                        <h3 id="attendance-tracking-with-user-time" class="betterdocs-content-heading" id="attendance-tracking-with-user-time">Attendance Tracking with User Time <a href="#attendance-tracking-with-user-time" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/recording-attendance/#attendance-tracking-with-user-time" data-title="Copy URL">#</a></h3>
                        ...
                        <figure class="wp-block-image size-full"><img decoding="async" width="900" height="500" src="https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-72.png" alt="" class="wp-image-2578" srcset="https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-72.png 900w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-72-300x167.png 300w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-72-768x427.png 768w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-72-600x333.png 600w" sizes="(max-width: 900px) 100vw, 900px" /></figure>
                        <h3 id="attendance-tracking-with-server-time" class="betterdocs-content-heading" id="attendance-tracking-with-server-time">Attendance Tracking with Server Time <a href="#attendance-tracking-with-server-time" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/recording-attendance/#attendance-tracking-with-server-time" data-title="Copy URL">#</a></h3>
                        ...
                        <figure class="wp-block-image size-full"><img decoding="async" loading="lazy" width="900" height="500" src="https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-73.png" alt="" class="wp-image-2579" srcset="https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-73.png 900w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-73-300x167.png 300w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-73-768x427.png 768w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-73-600x333.png 600w" sizes="(max-width: 900px) 100vw, 900px" /></figure>
                    </div>
                </div>
                ...
                <div class="docs-navigation"><a href="https://icehrm.com/explore/docs/timesheets/" rel="prev"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
                        ...
                        </svg> Timesheets</a><a href="https://icehrm.com/explore/docs/monitoring-attendance/" rel="next">Monitoring Attendance <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
