            ...
            <div id="betterdocs-single-main" class="docs-single-main">
                    ...
                    <div class="docs-single-title">
                        <nav id="betterdocs-breadcrumb" class="betterdocs-breadcrumb" xmlns:v="http://rdf.data-vocabulary.org/#">
                            <ul class="betterdocs-breadcrumb-list">
                                ...
                                <li class="betterdocs-breadcrumb-item item-current item-2463 current"><span>Subscribing To a Training Session</span></li>
                            </ul>
                        </nav>
                        <h1 id="betterdocs-entry-title" class="betterdocs-entry-title">Subscribing To a Training Session</h1>
                    </div>
                </header>
                <div class="betterdocs-entry-content">
                    ...
                    <div id="betterdocs-single-content" class="betterdocs-content">
                        ...
                        <figure class="wp-block-image size-full"><img decoding="async" width="900" height="300" src="https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-900-×-300px-6.png" alt="" class="wp-image-2464" srcset="https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-900-×-300px-6.png 900w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-900-×-300px-6-300x100.png 300w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-900-×-300px-6-768x256.png 768w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-900-×-300px-6-600x200.png 600w" sizes="(max-width: 900px) 100vw, 900px" /></figure>
                        <h2 id="attendance-type" class="betterdocs-content-heading" id="attendance-type">Attendance Type <a href="#attendance-type" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/subscribing-to-a-training-session/#attendance-type" data-title="Copy URL">#</a></h2>
                        <p>Employees can only subscribe to training sessions having Attendance Type set to “Sign Up”.</p>
                        <h1 id="completing-a-training-session" class="betterdocs-content-heading" id="completing-a-training-session">Completing a Training Session <a href="#completing-a-training-session" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/subscribing-to-a-training-session/#completing-a-training-session" data-title="Copy URL">#</a></h1>
                        ...
                        <h2 id="proof-of-completion" class="betterdocs-content-heading" id="proof-of-completion">Proof of Completion <a href="#proof-of-completion" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/subscribing-to-a-training-session/#proof-of-completion" data-title="Copy URL">#</a></h2>
                ...
                <div class="docs-navigation"><a href="https://icehrm.com/explore/docs/adding-a-new-training-session/" rel="prev"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
                        ...
                        </svg> Adding a New Training Session</a><a href="https://icehrm.com/explore/docs/approving-a-training-session/" rel="next">Approving a Training Session <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
