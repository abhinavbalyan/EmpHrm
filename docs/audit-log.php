    ...
    <div class="betterdocs-single-wraper betterdocs-single-bg betterdocs-single-layout1">
        ...
        <div class="betterdocs-content-area">
            ...
            <div id="betterdocs-single-main" class="docs-single-main">
                    ...
                    <div class="docs-single-title">
                        <nav id="betterdocs-breadcrumb" class="betterdocs-breadcrumb" xmlns:v="http://rdf.data-vocabulary.org/#">
                            <ul class="betterdocs-breadcrumb-list">
                                ...
                                <li class="betterdocs-breadcrumb-item item-current item-2566 current"><span>Audit Log</span></li>
                            </ul>
                        </nav>
                        <h1 id="betterdocs-entry-title" class="betterdocs-entry-title">Audit Log</h1>
                    </div>
                </header>
                <div class="betterdocs-entry-content">
                    ...
                    <div class="betterdocs-toc toc-list-number">
                        ...
                        <ul class="toc-list betterdocs-hierarchial-toc">
                            <li class="betterdocs-toc-heading-level-3"><a href="#0-toc-title">How to find who deleted an employee using the audit log?</a></li>
                        </ul>
                    </div>
                    <div id="betterdocs-single-content" class="betterdocs-content">
                        <p>The IceHrm Audit Log records all the activities performed by different users in the system. An audit log can help you monitor activities and even identify any potential security breaches and prevent unfavorable events. To access the audit log, go to <strong>Admin -> Audit log.</strong></p>
                        <p>In the audit log, you will be able to see:<br>1. The time an activity was performed<br>2. User<br>3. Employee name and id<br>4. Type of activity</p>
                        <figure class="wp-block-image size-full"><img decoding="async" width="900" height="500" src="https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-69.png" alt="" class="wp-image-2567" srcset="https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-69.png 900w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-69-300x167.png 300w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-69-768x427.png 768w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-69-600x333.png 600w" sizes="(max-width: 900px) 100vw, 900px" /></figure>
                        <h3 class="betterdocs-content-heading" id="0-toc-title">How to find who deleted an employee using the audit log? <a href="#0-toc-title" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/audit-log/#0-toc-title" data-title="Copy URL">#</a></h3>
                        <p>Go to <strong>admin -> audit log</strong> and search for the keyword &#8216;delete&#8217;. Once you have all the records with the type &#8216;delete&#8217;. Click on the view button to see which employee was deleted from the employee list.</p>
                        <figure class="wp-block-image size-full"><img decoding="async" loading="lazy" width="900" height="300" src="https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-900-×-300px-18.png" alt="" class="wp-image-2568" srcset="https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-900-×-300px-18.png 900w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-900-×-300px-18-300x100.png 300w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-900-×-300px-18-768x256.png 768w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-900-×-300px-18-600x200.png 600w" sizes="(max-width: 900px) 100vw, 900px" /></figure>
                    </div>
                </div>
                ...
                <div class="docs-navigation"><a href="https://icehrm.com/explore/docs/company-loans/" rel="prev"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
