    ...
    <div class="betterdocs-single-wraper betterdocs-single-bg betterdocs-single-layout1">
        ...
        <div class="betterdocs-content-area">
            ...
            <div id="betterdocs-single-main" class="docs-single-main">
                    ...
                    <div class="docs-single-title">
                        <nav id="betterdocs-breadcrumb" class="betterdocs-breadcrumb" xmlns:v="http://rdf.data-vocabulary.org/#">
                            <ul class="betterdocs-breadcrumb-list">
                                ...
                                <li class="betterdocs-breadcrumb-item item-current item-1296 current"><span>Company Loans</span></li>
                            </ul>
                        </nav>
                        <h1 id="betterdocs-entry-title" class="betterdocs-entry-title">Company Loans</h1>
                    </div>
                </header>
                <div class="betterdocs-entry-content">
                    ...
                    <div class="betterdocs-toc toc-list-number">
                        ...
                        <ul class="toc-list betterdocs-hierarchial-toc">
                            <li class="betterdocs-toc-heading-level-2"><a href="#how-to-add-an-employee-loan-as-an-admin">How to add an Employee Loan as an admin?</a></li>
                            <li class="betterdocs-toc-heading-level-2"><a href="#how-to-view-loans-taken-as-an-employee">How to view Loans Taken as an employee?</a></li>
                        </ul>
                    </div>
                    <div id="betterdocs-single-content" class="betterdocs-content">
                        <p>The company Loans module lets you track loans taken by your employees.</p>
                        <h2 id="how-to-add-an-employee-loan-as-an-admin" class="betterdocs-content-heading" id="how-to-add-an-employee-loan-as-an-admin">How to add an Employee Loan as an admin? <a href="#how-to-add-an-employee-loan-as-an-admin" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/company-loans/#how-to-add-an-employee-loan-as-an-admin" data-title="Copy URL">#</a></h2>
                        <p>To add an employee Loan as an Admin:</p>
                        <ol>
                            <li>Go to<strong> Manage -> Loans.</strong></li>
                            <li>Define the loan types under the <strong>Loan Types</strong> tab.</li>
                        </ol>
                        <figure class="wp-block-image size-large"><img decoding="async" width="1024" height="330" src="https://icehrm.com/explore/wp-content/uploads/2021/11/loantypes-1024x330.png" alt="" class="wp-image-1298" srcset="https://icehrm.com/explore/wp-content/uploads/2021/11/loantypes-1024x330.png 1024w, https://icehrm.com/explore/wp-content/uploads/2021/11/loantypes-300x97.png 300w, https://icehrm.com/explore/wp-content/uploads/2021/11/loantypes-768x248.png 768w, https://icehrm.com/explore/wp-content/uploads/2021/11/loantypes-600x194.png 600w, https://icehrm.com/explore/wp-content/uploads/2021/11/loantypes.png 1116w" sizes="(max-width: 1024px) 100vw, 1024px" /></figure>
                        <p>3. Go to the <strong>Employees Loans</strong> tab and add a new employee loan.</p>
                        <figure class="wp-block-image size-large"><img decoding="async" loading="lazy" width="1024" height="601" src="https://icehrm.com/explore/wp-content/uploads/2021/11/employeeloans-1024x601.png" alt="" class="wp-image-1299" srcset="https://icehrm.com/explore/wp-content/uploads/2021/11/employeeloans-1024x601.png 1024w, https://icehrm.com/explore/wp-content/uploads/2021/11/employeeloans-300x176.png 300w, https://icehrm.com/explore/wp-content/uploads/2021/11/employeeloans-768x451.png 768w, https://icehrm.com/explore/wp-content/uploads/2021/11/employeeloans-600x352.png 600w, https://icehrm.com/explore/wp-content/uploads/2021/11/employeeloans.png 1107w" sizes="(max-width: 1024px) 100vw, 1024px" /></figure>
                        <p></p>
                        <figure class="wp-block-image size-large"><img decoding="async" loading="lazy" width="1024" height="301" src="https://icehrm.com/explore/wp-content/uploads/2021/11/saveloan-1024x301.png" alt="" class="wp-image-1301" srcset="https://icehrm.com/explore/wp-content/uploads/2021/11/saveloan-1024x301.png 1024w, https://icehrm.com/explore/wp-content/uploads/2021/11/saveloan-300x88.png 300w, https://icehrm.com/explore/wp-content/uploads/2021/11/saveloan-768x226.png 768w, https://icehrm.com/explore/wp-content/uploads/2021/11/saveloan-600x176.png 600w, https://icehrm.com/explore/wp-content/uploads/2021/11/saveloan.png 1105w" sizes="(max-width: 1024px) 100vw, 1024px" /></figure>
                        <h2 id="how-to-view-loans-taken-as-an-employee" class="betterdocs-content-heading" id="how-to-view-loans-taken-as-an-employee">How to view Loans Taken as an employee? <a href="#how-to-view-loans-taken-as-an-employee" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/company-loans/#how-to-view-loans-taken-as-an-employee" data-title="Copy URL">#</a></h2>
                        <p>Once the Employee Loan is saved under Employee loans, the employee will be able to view the loan details in <strong>Finance -&gt; Loans </strong>under the <strong>Loans Taken </strong>tab<strong>.</strong></p>
                        <figure class="wp-block-image size-large"><img decoding="async" loading="lazy" width="1024" height="257" src="https://icehrm.com/explore/wp-content/uploads/2021/11/loanstaken-1024x257.png" alt="" class="wp-image-1302" srcset="https://icehrm.com/explore/wp-content/uploads/2021/11/loanstaken-1024x257.png 1024w, https://icehrm.com/explore/wp-content/uploads/2021/11/loanstaken-300x75.png 300w, https://icehrm.com/explore/wp-content/uploads/2021/11/loanstaken-768x193.png 768w, https://icehrm.com/explore/wp-content/uploads/2021/11/loanstaken-600x150.png 600w, https://icehrm.com/explore/wp-content/uploads/2021/11/loanstaken.png 1109w" sizes="(max-width: 1024px) 100vw, 1024px" /></figure>
                    </div>
                </div>
                ...
                <div class="docs-navigation"><a href="https://icehrm.com/explore/docs/data-import/" rel="prev"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
                        ...
                        </svg> Data Import</a><a href="https://icehrm.com/explore/docs/audit-log/" rel="next">Audit Log <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
