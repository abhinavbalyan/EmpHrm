            ...
            <div id="betterdocs-single-main" class="docs-single-main">
                    ...
                    <div class="docs-single-title">
                        <nav id="betterdocs-breadcrumb" class="betterdocs-breadcrumb" xmlns:v="http://rdf.data-vocabulary.org/#">
                            <ul class="betterdocs-breadcrumb-list">
                                ...
                                <li class="betterdocs-breadcrumb-item item-current item-2559 current"><span>Filling an HR Form As an Employee</span></li>
                            </ul>
                        </nav>
                        <h1 id="betterdocs-entry-title" class="betterdocs-entry-title">Filling an HR Form As an Employee</h1>
                    </div>
                </header>
                <div class="betterdocs-entry-content">
                    ...
                    <div id="betterdocs-single-content" class="betterdocs-content">
                        ...
                        <p>Then click on the Fill button. After filling out the HR Form employee can Save the HR form and then Submit the Form.</p>
                        <figure class="wp-block-image size-full is-resized"><img decoding="async" src="https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-900-×-300px-15.png" alt="" class="wp-image-2560" width="1011" height="337" srcset="https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-900-×-300px-15.png 900w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-900-×-300px-15-300x100.png 300w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-900-×-300px-15-768x256.png 768w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-900-×-300px-15-600x200.png 600w" sizes="(max-width: 1011px) 100vw, 1011px" /></figure>
                ...
                <div class="docs-navigation"><a href="https://icehrm.com/explore/docs/assigning-an-hr-form-to-an-employee/" rel="prev"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
                        ...
                        </svg> Assigning an HR Form To an Employee</a><a href="https://icehrm.com/explore/docs/downloading-an-hr-form-as-a-pdf-report/" rel="next">Downloading an HR Form as a PDF Report <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
