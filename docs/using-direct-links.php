            ...
            <div id="betterdocs-single-main" class="docs-single-main">
                    ...
                    <div class="docs-single-title">
                        <nav id="betterdocs-breadcrumb" class="betterdocs-breadcrumb" xmlns:v="http://rdf.data-vocabulary.org/#">
                            <ul class="betterdocs-breadcrumb-list">
                                ...
                                <li class="betterdocs-breadcrumb-item item-current item-2444 current"><span>Sharing Your Job Using Direct Links</span></li>
                            </ul>
                        </nav>
                        <h1 id="betterdocs-entry-title" class="betterdocs-entry-title">Sharing Your Job Using Direct Links</h1>
                    </div>
                </header>
                <div class="betterdocs-entry-content">
                    ...
                    <div id="betterdocs-single-content" class="betterdocs-content">
                        <p>You can get a direct link to the job position which you can send via email or any other media by clicking on the “Job Link” icon.</p>
                        <figure class="wp-block-image size-full"><img decoding="async" width="900" height="500" src="https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-41.png" alt="" class="wp-image-2445" srcset="https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-41.png 900w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-41-300x167.png 300w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-41-768x427.png 768w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-41-600x333.png 600w" sizes="(max-width: 900px) 100vw, 900px" /></figure>
                        <p>You can open up the link and view your job post prior to sharing it. Then a candidate can apply for this job and the candidate details will be available under the candidate listing<strong>.</strong></p>
                        <figure class="wp-block-image size-full"><img decoding="async" loading="lazy" width="900" height="900" src="https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-900-×-900px-4.png" alt="" class="wp-image-2653" srcset="https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-900-×-900px-4.png 900w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-900-×-900px-4-300x300.png 300w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-900-×-900px-4-150x150.png 150w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-900-×-900px-4-768x768.png 768w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-900-×-900px-4-600x600.png 600w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-900-×-900px-4-100x100.png 100w" sizes="(max-width: 900px) 100vw, 900px" /></figure>
                        <p>When candidates apply for a job post, candidates and the relevant hiring managers will receive email notifications.</p>
                    </div>
                </div>
                ...
                <div class="docs-navigation"><a href="https://icehrm.com/explore/docs/posting-a-job/" rel="prev"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
                        ...
                        </svg> Posting a Job</a><a href="https://icehrm.com/explore/docs/adding-candidates/" rel="next">Adding Candidates <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
