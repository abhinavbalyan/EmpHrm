            ...
            <div id="betterdocs-single-main" class="docs-single-main">
                    ...
                    <div class="docs-single-title">
                        <nav id="betterdocs-breadcrumb" class="betterdocs-breadcrumb" xmlns:v="http://rdf.data-vocabulary.org/#">
                            <ul class="betterdocs-breadcrumb-list">
                                ...
                                <li class="betterdocs-breadcrumb-item item-current item-2430 current"><span>Adding And Editing a New Job Function</span></li>
                            </ul>
                        </nav>
                        <h1 id="betterdocs-entry-title" class="betterdocs-entry-title">Adding And Editing a New Job Function</h1>
                    </div>
                </header>
                <div class="betterdocs-entry-content">
                    ...
                    <div id="betterdocs-single-content" class="betterdocs-content">
                        <p>In the IceHrm Recruitment set up, we have defined most of the important job functions. If you want to make changes to the names, you can click on the edit button and make changes.</p>
                        <figure class="wp-block-image size-full"><img decoding="async" width="900" height="500" src="https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-34.png" alt="" class="wp-image-2431" srcset="https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-34.png 900w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-34-300x167.png 300w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-34-768x427.png 768w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-34-600x333.png 600w" sizes="(max-width: 900px) 100vw, 900px" /></figure>
                    </div>
                </div>
                ...
                <div class="docs-navigation"><a href="https://icehrm.com/explore/docs/adding-a-new-experience-level/" rel="prev"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
                        ...
                        </svg> Adding a New Experience Level</a><a href="https://icehrm.com/explore/docs/posting-a-job/" rel="next">Posting a Job <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
