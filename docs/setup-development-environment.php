                    ...
                    <div class="docs-single-title">
                        <nav id="betterdocs-breadcrumb" class="betterdocs-breadcrumb" xmlns:v="http://rdf.data-vocabulary.org/#">
                            <ul class="betterdocs-breadcrumb-list">
                                ...
                                <li class="betterdocs-breadcrumb-item item-current item-1204 current"><span>Setup Development Environment</span></li>
                            </ul>
                        </nav>
                        <h1 id="betterdocs-entry-title" class="betterdocs-entry-title">Setup Development Environment</h1>
                    </div>
                </header>
                <div class="betterdocs-entry-content">
                    ...
                    <div class="betterdocs-toc toc-list-number">
                        ...
                        <ul class="toc-list betterdocs-hierarchial-toc">
                            <li class="betterdocs-toc-heading-level-2"><a href="#0-toc-title">Clone the Icehrm repo</a></li>
                            <li class="betterdocs-toc-heading-level-2"><a href="#1-toc-title">Check prerequisites</a>
                                <ul class="betterdocs-toc-list-level-3">
                                    <li class="betterdocs-toc-heading-level-3"><a href="#2-toc-title">Install Virtual Box</a></li>
                                    <li class="betterdocs-toc-heading-level-3"><a href="#3-toc-title">Install Vagrant</a></li>
                                </ul>
                            </li>
                            <li class="betterdocs-toc-heading-level-2"><a href="#4-toc-title">Build Frontend Assets</a></li>
                            <li class="betterdocs-toc-heading-level-2"><a href="#5-toc-title">Add Development Configuration</a></li>
                            <li class="betterdocs-toc-heading-level-2"><a href="#6-toc-title">Start Vagrant</a></li>
                        </ul>
                    </div>
                    <div id="betterdocs-single-content" class="betterdocs-content">
                        <p>Here you will learn how to set up your development environment for Icehrm.</p>
                        <h2 class="betterdocs-content-heading" id="0-toc-title">Clone the Icehrm repo <a href="#0-toc-title" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/setup-development-environment/#0-toc-title" data-title="Copy URL">#</a></h2>
                        <pre class="wp-block-code"><code>$ git clone https://github.com/gamonoid/icehrm.git</code></pre>
                        <h2 class="betterdocs-content-heading" id="1-toc-title">Check prerequisites <a href="#1-toc-title" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/setup-development-environment/#1-toc-title" data-title="Copy URL">#</a></h2>
                        <p>You will be more productive when using vagrant for your development environment.</p>
                        <h3 class="betterdocs-content-heading" id="2-toc-title">Install Virtual Box <a href="#2-toc-title" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/setup-development-environment/#2-toc-title" data-title="Copy URL">#</a></h3>
                        <p>Please download and install virtual box for your platform from here: <a href="https://www.virtualbox.org/wiki/Downloads">https://www.virtualbox.org/wiki/Downloads</a></p>
                        <h3 class="betterdocs-content-heading" id="3-toc-title">Install Vagrant <a href="#3-toc-title" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/setup-development-environment/#3-toc-title" data-title="Copy URL">#</a></h3>
                        <p>Instructions for installing vagrant <a href="https://www.vagrantup.com/docs/installation">https://www.vagrantup.com/docs/installation</a></p>
                        <p>Then we need to install Vagrant host updater plugin.</p>
                        <pre class="wp-block-code"><code>$ vagrant plugin install vagrant-hostsupdater</code></pre>
                        <h2 class="betterdocs-content-heading" id="4-toc-title">Build Frontend Assets <a href="#4-toc-title" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/setup-development-environment/#4-toc-title" data-title="Copy URL">#</a></h2>
                        <p>Icehrm has two pakage.json files. Once under the root and the other one under /web directory. NPM should run on both locations</p>
...
$ gulp</code></pre>
                        <h2 class="betterdocs-content-heading" id="5-toc-title">Add Development Configuration <a href="#5-toc-title" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/setup-development-environment/#5-toc-title" data-title="Copy URL">#</a></h2>
                        <p>Create file <strong>icehrm/app/config.php</strong></p>
...
define('MAX_FILE_SIZE_KB', 10 * 1024);</code></pre>
                        <h2 class="betterdocs-content-heading" id="6-toc-title">Start Vagrant <a href="#6-toc-title" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/setup-development-environment/#6-toc-title" data-title="Copy URL">#</a></h2>
                        <p>The pre-built IceHrm vagrant box contains php 7.3 / nginx and MySQL 5.7 installed. Nginx configurations are loaded from <strong>icehrm/deployment/vagrant.</strong></p>
                        <pre class="wp-block-code"><code>$ vagrant up</code></pre>
                        <p>Then navigate to <a href="http://icehrm.os">http://icehrm.os</a> and login with credentials, admin / admin.</p>
                    </div>
                </div>
                ...
                <div class="docs-navigation"><a href="https://icehrm.com/explore/docs/creating-first-extension/" rel="next">Creating First Extension <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
