    ...
    <div class="betterdocs-single-wraper betterdocs-single-bg betterdocs-single-layout1">
        ...
        <div class="betterdocs-content-area">
            ...
            <div id="betterdocs-single-main" class="docs-single-main">
                    ...
                    <div class="docs-single-title">
                        <nav id="betterdocs-breadcrumb" class="betterdocs-breadcrumb" xmlns:v="http://rdf.data-vocabulary.org/#">
                            <ul class="betterdocs-breadcrumb-list">
                                ...
                                <li class="betterdocs-breadcrumb-item item-current item-2701 current"><span>Supervisors and Indirect Supervisors</span></li>
                            </ul>
                        </nav>
                        <h1 id="betterdocs-entry-title" class="betterdocs-entry-title">Supervisors and Indirect Supervisors</h1>
                    </div>
                </header>
                <div class="betterdocs-entry-content">
                    ...
                    <div class="betterdocs-toc toc-list-number">
                        ...
                        <ul class="toc-list betterdocs-hierarchial-toc">
                            <li class="betterdocs-toc-heading-level-2"><a href="#0-toc-title">Supervisors</a></li>
                            <li class="betterdocs-toc-heading-level-2"><a href="#indirect-supervisors">Indirect Supervisors</a></li>
                        </ul>
                    </div>
                    <div id="betterdocs-single-content" class="betterdocs-content">
                        <h2 class="betterdocs-content-heading" id="0-toc-title">Supervisors <a href="#0-toc-title" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/supervisors-and-indirect-supervisors/#0-toc-title" data-title="Copy URL">#</a></h2>
                        <ol>
                            <li>Any employee can be the supervisor of another employee.</li>
                            <li>The supervisor of an Employee can be added by changing the supervisor field of the employee edit screen.</li>
                            <li> If the employee is having Admin or Manager user level, they can view all their subordinates (employees having the current employee as the supervisor) via the <strong>Employees => Employees</strong> menu.</li>
                        </ol>
                        <h2 id="indirect-supervisors" class="betterdocs-content-heading" id="indirect-supervisors">Indirect Supervisors <a href="#indirect-supervisors" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/supervisors-and-indirect-supervisors/#indirect-supervisors" data-title="Copy URL">#</a></h2>
                        <ol>
                            <li>An employee can have multiple Indirect Supervisors which can be set via edit employee.</li>
                            <li>2. Indirect supervisors are useful when approving leave requests (You can allow indirect supervisors to approve leave requests via <strong>Settings -> Leave</strong>).</li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="docs-navigation"><a href="https://icehrm.com/explore/docs/adding-and-switching-employees/" rel="prev"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
                        ...
                        </svg> Adding and Switching Employees</a><a href="https://icehrm.com/explore/docs/department-heads/" rel="next">Department Heads <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
