            ...
            <div id="betterdocs-single-main" class="docs-single-main">
                    ...
                    <div class="docs-single-title">
                        <nav id="betterdocs-breadcrumb" class="betterdocs-breadcrumb" xmlns:v="http://rdf.data-vocabulary.org/#">
                            <ul class="betterdocs-breadcrumb-list">
                                ...
                                <li class="betterdocs-breadcrumb-item item-current item-2706 current"><span>Deleting Employee Data</span></li>
                            </ul>
                        </nav>
                        <h1 id="betterdocs-entry-title" class="betterdocs-entry-title">Deleting Employee Data</h1>
                    </div>
                </header>
                <div class="betterdocs-entry-content">
                    ...
                    <div id="betterdocs-single-content" class="betterdocs-content">
                        <p>In order to delete an employee, an admin should first click the <strong>“Deactivate”</strong> button on the employee list. But we do not delete the employee data at this time. Instead, the employee is moved to the “Deactivated” tab. When an employee is in the <strong>“Deactivated”</strong> list, you can recover all the employee data with one click.</p>
                        <p>If you delete the employee from the <strong>“Deactivated”</strong> tab, the Employee profile will be moved to the <strong>“Archived”</strong> tab<strong>. </strong>At this point<strong>,</strong> you can not recover the employee, but still, you can download all the data of the employee in JSON format.</p>
                        <p>If you want to remove all the data related to the employee you can delete data in&nbsp;<strong>“Archived”</strong>&nbsp;also.</p>
                        <p>When billing for cloud-hosted installation, we consider the count of active employees and employees under the <strong>“Deactivated”</strong> tab. So if you do not want to get billed for an employee you need to delete the employee from the <strong>“Deactivated”</strong> tab also.</p>
                    </div>
                </div>
                ...
                <div class="docs-navigation"><a href="https://icehrm.com/explore/docs/department-heads/" rel="prev"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
                        ...
                        </svg> Department Heads</a><a href="https://icehrm.com/explore/docs/employee-history/" rel="next">Employee History <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
