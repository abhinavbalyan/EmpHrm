            ...
            <div id="betterdocs-single-main" class="docs-single-main">
                    ...
                    <div class="docs-single-title">
                        <nav id="betterdocs-breadcrumb" class="betterdocs-breadcrumb" xmlns:v="http://rdf.data-vocabulary.org/#">
                            <ul class="betterdocs-breadcrumb-list">
                                ...
                                <li class="betterdocs-breadcrumb-item item-current item-2659 current"><span>Defining Company Structure</span></li>
                            </ul>
                        </nav>
                        <h1 id="betterdocs-entry-title" class="betterdocs-entry-title">Defining Company Structure</h1>
                    </div>
                </header>
                <div class="betterdocs-entry-content">
                    ...
                    <div id="betterdocs-single-content" class="betterdocs-content">
                        <p>The company structure module allows you to define the structure of your company. It lets you create the parent structure of the company, branches, departments, and other company units.</p>
                        <figure class="wp-block-image size-full"><img decoding="async" width="900" height="500" src="https://icehrm.com/explore/wp-content/uploads/2022/10/Untitled-design-81.png" alt="" class="wp-image-2660" srcset="https://icehrm.com/explore/wp-content/uploads/2022/10/Untitled-design-81.png 900w, https://icehrm.com/explore/wp-content/uploads/2022/10/Untitled-design-81-300x167.png 300w, https://icehrm.com/explore/wp-content/uploads/2022/10/Untitled-design-81-768x427.png 768w, https://icehrm.com/explore/wp-content/uploads/2022/10/Untitled-design-81-600x333.png 600w" sizes="(max-width: 900px) 100vw, 900px" /></figure>
                        <p>Also, it provides a graphical overview of how each of your company units is connected.</p>
                        <figure class="wp-block-image size-full"><img decoding="async" loading="lazy" width="900" height="500" src="https://icehrm.com/explore/wp-content/uploads/2022/10/Untitled-design-82.png" alt="" class="wp-image-2661" srcset="https://icehrm.com/explore/wp-content/uploads/2022/10/Untitled-design-82.png 900w, https://icehrm.com/explore/wp-content/uploads/2022/10/Untitled-design-82-300x167.png 300w, https://icehrm.com/explore/wp-content/uploads/2022/10/Untitled-design-82-768x427.png 768w, https://icehrm.com/explore/wp-content/uploads/2022/10/Untitled-design-82-600x333.png 600w" sizes="(max-width: 900px) 100vw, 900px" />
                ...
                <div class="docs-navigation"><a href="https://icehrm.com/explore/docs/user-permissions/" rel="prev"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
                        ...
                        </svg> User Permissions</a><a href="https://icehrm.com/explore/docs/configuring-a-manager-as-the-head-of-the-company-structure-and-enable-to-view-all-employees/" rel="next">Configuring The Head Of a Company Structure <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
