            ...
            <div id="betterdocs-single-main" class="docs-single-main">
                    ...
                    <div class="docs-single-title">
                        <nav id="betterdocs-breadcrumb" class="betterdocs-breadcrumb" xmlns:v="http://rdf.data-vocabulary.org/#">
                            <ul class="betterdocs-breadcrumb-list">
                                ...
                                <li class="betterdocs-breadcrumb-item item-current item-2697 current"><span>Adding and Switching Employees</span></li>
                            </ul>
                        </nav>
                        <h1 id="betterdocs-entry-title" class="betterdocs-entry-title">Adding and Switching Employees</h1>
                    </div>
                </header>
                <div class="betterdocs-entry-content">
                    ...
                    <div id="betterdocs-single-content" class="betterdocs-content">
                        <h2 id="adding-employees" class="betterdocs-content-heading" id="adding-employees">Adding Employees <a href="#adding-employees" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/adding-and-switching-employees/#adding-employees" data-title="Copy URL">#</a></h2>
                        ...
                        <h2 id="switching-employees" class="betterdocs-content-heading" id="switching-employees">Switching Employees <a href="#switching-employees" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/adding-and-switching-employees/#switching-employees" data-title="Copy URL">#</a></h2>
                        ...
                        <figure class="wp-block-image size-full"><img decoding="async" width="900" height="300" src="https://icehrm.com/explore/wp-content/uploads/2022/10/Untitled-900-×-300px-28.png" alt="" class="wp-image-2698" srcset="https://icehrm.com/explore/wp-content/uploads/2022/10/Untitled-900-×-300px-28.png 900w, https://icehrm.com/explore/wp-content/uploads/2022/10/Untitled-900-×-300px-28-300x100.png 300w, https://icehrm.com/explore/wp-content/uploads/2022/10/Untitled-900-×-300px-28-768x256.png 768w, https://icehrm.com/explore/wp-content/uploads/2022/10/Untitled-900-×-300px-28-600x200.png 600w" sizes="(max-width: 900px) 100vw, 900px" /></figure>
                    </div>
                </div>
                <div class="betterdocs-entry-footer">
                    <div class="feedback-update-form">
                        ...
                        <div class="update-date">
                            Updated on October 10, 2022 </div>
                    </div>
                </div>
                <div class="docs-navigation"><a href="https://icehrm.com/explore/docs/understanding-users-and-employees/" rel="prev"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
                        ...
                        </svg> Understanding Users and Employees</a><a href="https://icehrm.com/explore/docs/supervisors-and-indirect-supervisors/" rel="next">Supervisors and Indirect Supervisors <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
