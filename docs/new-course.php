            ...
            <div id="betterdocs-single-main" class="docs-single-main">
                    ...
                    <div class="docs-single-title">
                        <nav id="betterdocs-breadcrumb" class="betterdocs-breadcrumb" xmlns:v="http://rdf.data-vocabulary.org/#">
                            <ul class="betterdocs-breadcrumb-list">
                                ...
                                <li class="betterdocs-breadcrumb-item item-current item-2459 current"><span>Adding a New Course</span></li>
                            </ul>
                        </nav>
                        <h1 id="betterdocs-entry-title" class="betterdocs-entry-title">Adding a New Course</h1>
                    </div>
                </header>
                <div class="betterdocs-entry-content">
                    ...
                    <div id="betterdocs-single-content" class="betterdocs-content">
                        ...
                        <h1 id="adding-a-new-course" class="betterdocs-content-heading" id="adding-a-new-course">Adding a new Course <a href="#adding-a-new-course" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/adding-a-new-course/#adding-a-new-course" data-title="Copy URL">#</a></h1>
                ...
                <div class="docs-navigation"><a href="https://icehrm.com/explore/docs/training-module/" rel="prev"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
                        ...
                        </svg> Training Module</a><a href="https://icehrm.com/explore/docs/adding-a-new-training-session/" rel="next">Adding a New Training Session <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
