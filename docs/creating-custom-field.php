            ...
            <div id="betterdocs-single-main" class="docs-single-main">
                    ...
                    <div class="docs-single-title">
                        <nav id="betterdocs-breadcrumb" class="betterdocs-breadcrumb" xmlns:v="http://rdf.data-vocabulary.org/#">
                            <ul class="betterdocs-breadcrumb-list">
                                ...
                                <li class="betterdocs-breadcrumb-item item-current item-2485 current"><span>Creating a Custom Field For Travel Requests</span></li>
                            </ul>
                        </nav>
                        <h1 id="betterdocs-entry-title" class="betterdocs-entry-title">Creating a Custom Field For Travel Requests</h1>
                    </div>
                </header>
                <div class="betterdocs-entry-content">
                    ...
                    <div id="betterdocs-single-content" class="betterdocs-content">
                        <p>You can create a custom field for the Travel Request Form under the Admin account. Navigate to <strong>Admin -> Custom Field -> Add New</strong>. Fill the below Necessary fields to create the new custom field:</p>
                        <ol>
                        ...
                        <figure class="wp-block-image size-full"><img decoding="async" width="900" height="500" src="https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-51.png" alt="" class="wp-image-2486" srcset="https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-51.png 900w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-51-300x167.png 300w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-51-768x427.png 768w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-51-600x333.png 600w" sizes="(max-width: 900px) 100vw, 900px" /></figure>
                        <p>You can see the created custom field under the travel request form.</p>
                        <p><a href="https://icehrm.com/explore/docs/travel-module/#betterdocs-form-modal"></a></p>
                    </div>
                </div>
                ...
                <div class="docs-navigation"><a href="https://icehrm.com/explore/docs/approving-a-travel-request-as-an-admin/" rel="prev"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
                        ...
                        </svg> Approving a Travel Request As an Admin</a></div>
