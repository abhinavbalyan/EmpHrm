    ...
    <div class="betterdocs-single-wraper betterdocs-single-bg betterdocs-single-layout1">
        ...
        <div class="betterdocs-content-area">
            ...
            <div id="betterdocs-single-main" class="docs-single-main">
                    ...
                    <div class="docs-single-title">
                        <nav id="betterdocs-breadcrumb" class="betterdocs-breadcrumb" xmlns:v="http://rdf.data-vocabulary.org/#">
                            <ul class="betterdocs-breadcrumb-list">
                                ...
                                <li class="betterdocs-breadcrumb-item item-current item-2488 current"><span>Adding Expenses</span></li>
                            </ul>
                        </nav>
                        <h1 id="betterdocs-entry-title" class="betterdocs-entry-title">Adding Expenses</h1>
                    </div>
                </header>
                <div class="betterdocs-entry-content">
                    ...
                    <div class="betterdocs-toc toc-list-number">
                        ...
                        <ul class="toc-list betterdocs-hierarchial-toc">
                            <li class="betterdocs-toc-heading-level-1"><a href="#adding-expenses">Adding Expenses</a></li>
                        </ul>
                    </div>
                    <div id="betterdocs-single-content" class="betterdocs-content">
                        ...
                        <h1 id="adding-expenses" class="betterdocs-content-heading" id="adding-expenses">Adding Expenses <a href="#adding-expenses" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/adding-expenses/#adding-expenses" data-title="Copy URL">#</a></h1>
                        ...
                        <figure class="wp-block-image size-full is-resized"><img decoding="async" src="https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-52.png" alt="" class="wp-image-2489" width="1103" height="613" srcset="https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-52.png 900w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-52-300x167.png 300w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-52-768x427.png 768w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-52-600x333.png 600w" sizes="(max-width: 1103px) 100vw, 1103px" /></figure>
                    </div>
                </div>
                ...
                <div class="docs-navigation"><a href="https://icehrm.com/explore/docs/expense-management/" rel="prev"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
                        ...
                        </svg> Expense Management</a><a href="https://icehrm.com/explore/docs/adding-an-expense-category/" rel="next">Adding an Expense Category <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
