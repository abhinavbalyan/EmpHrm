            ...
            <div id="betterdocs-single-main" class="docs-single-main">
                    ...
                    <div class="docs-single-title">
                        <nav id="betterdocs-breadcrumb" class="betterdocs-breadcrumb" xmlns:v="http://rdf.data-vocabulary.org/#">
                            <ul class="betterdocs-breadcrumb-list">
                                ...
                                <li class="betterdocs-breadcrumb-item item-current item-2478 current"><span>Assigning a Travel Request As an Admin/Manager</span></li>
                            </ul>
                        </nav>
                        <h1 id="betterdocs-entry-title" class="betterdocs-entry-title">Assigning a Travel Request As an Admin/Manager</h1>
                    </div>
                </header>
                <div class="betterdocs-entry-content">
                    ...
                    <div id="betterdocs-single-content" class="betterdocs-content">
                        <p>Admin/Managers can log into their IceHrm accounts. In the <strong>Dashboard</strong>, they can find the <strong>Travel Request </strong>module. Or Navigate to<strong> Manage -> Travel -> Travel Request -> Add New</strong>.</p>
                        <ol>
                            <li>You need to<strong> fill in the below fields</strong> to create a travel request.</li>
                        </ol>
                        <ul>
                            ...
                            <li><strong>Purpose of Travel </strong>— Employees can enter a detailed description of the purpose of traveling</li>
                        ...
                        <figure class="wp-block-image size-full"><img decoding="async" width="900" height="500" src="https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-49.png" alt="" class="wp-image-2479" srcset="https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-49.png 900w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-49-300x167.png 300w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-49-768x427.png 768w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-49-600x333.png 600w" sizes="(max-width: 900px) 100vw, 900px" /></figure>
                ...
                <div class="docs-navigation"><a href="https://icehrm.com/explore/docs/creating-a-travel-request-as-an-employee/" rel="prev"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
                        ...
                        </svg> Creating a Travel Request As an Employee</a><a href="https://icehrm.com/explore/docs/approving-a-travel-request-as-an-admin/" rel="next">Approving a Travel Request As an Admin <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
