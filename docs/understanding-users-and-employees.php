            ...
            <div id="betterdocs-single-main" class="docs-single-main">
                    ...
                    <div class="docs-single-title">
                        <nav id="betterdocs-breadcrumb" class="betterdocs-breadcrumb" xmlns:v="http://rdf.data-vocabulary.org/#">
                            <ul class="betterdocs-breadcrumb-list">
                                ...
                                <li class="betterdocs-breadcrumb-item item-current item-2667 current"><span>Understanding Users and Employees</span></li>
                            </ul>
                        </nav>
                        <h1 id="betterdocs-entry-title" class="betterdocs-entry-title">Understanding Users and Employees</h1>
                    </div>
                </header>
                <div class="betterdocs-entry-content">
                    ...
                    <div id="betterdocs-single-content" class="betterdocs-content">
                        ...
                        <h2 id="adding-employees" class="betterdocs-content-heading" id="adding-employees">Adding Employees <a href="#adding-employees" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/understanding-users-and-employees/#adding-employees" data-title="Copy URL">#</a></h2>
                        <p>Adding employees to ICE Hrm can only be done by the admin. The employee Id field should have a unique value. In order to complete adding an employee, you need to provide the job title, employment status, and pay grade.</p>
                        <p>Once an employee is added to the system you will be asked to create a user for the newly added employee.</p>
                        <h2 id="switching-employees" class="betterdocs-content-heading" id="switching-employees">Switching Employees <a href="#switching-employees" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/understanding-users-and-employees/#switching-employees" data-title="Copy URL">#</a></h2>
                        <p>One of the key features of ICE Hrm, is admins and managers have the ability to log in as another employee. This feature can be used to apply for leave requests, add attendance records, or update timesheets on behalf of other employees.</p>
                        <p>To log in as an employee, you can use the Login as button on the employee list or the “Switch” button in the top right-hand corner.</p>
                        <figure class="wp-block-image size-full"><img decoding="async" width="900" height="500" src="https://icehrm.com/explore/wp-content/uploads/2022/10/Untitled-design-84.png" alt="" class="wp-image-2668" srcset="https://icehrm.com/explore/wp-content/uploads/2022/10/Untitled-design-84.png 900w, https://icehrm.com/explore/wp-content/uploads/2022/10/Untitled-design-84-300x167.png 300w, https://icehrm.com/explore/wp-content/uploads/2022/10/Untitled-design-84-768x427.png 768w, https://icehrm.com/explore/wp-content/uploads/2022/10/Untitled-design-84-600x333.png 600w" sizes="(max-width: 900px) 100vw, 900px" /></figure>
                    </div>
                </div>
                <div class="betterdocs-entry-footer">
                    <div class="feedback-update-form">
                        ...
                        <div class="update-date">
                            Updated on October 5, 2022 </div>
                    </div>
                </div>
                <div class="docs-navigation"><a href="https://icehrm.com/explore/docs/configuring-a-manager-as-the-head-of-the-company-structure-and-enable-to-view-all-employees/" rel="prev"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
                        ...
                        </svg> Configuring The Head Of a Company Structure</a><a href="https://icehrm.com/explore/docs/adding-and-switching-employees/" rel="next">Adding and Switching Employees <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
