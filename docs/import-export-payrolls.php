                    ...
                    <div class="docs-single-title">
                        <nav id="betterdocs-breadcrumb" class="betterdocs-breadcrumb" xmlns:v="http://rdf.data-vocabulary.org/#">
                            <ul class="betterdocs-breadcrumb-list">
                                ...
                                <li class="betterdocs-breadcrumb-item item-current item-1162 current"><span>Import &#8211; Export Payrolls</span></li>
                            </ul>
                        </nav>
                        <h1 id="betterdocs-entry-title" class="betterdocs-entry-title">Import &#8211; Export Payrolls</h1>
                    </div>
                </header>
                <div class="betterdocs-entry-content">
                    ...
                    <div class="betterdocs-toc toc-list-number">
                        ...
                        <ul class="toc-list betterdocs-hierarchial-toc">
                            <li class="betterdocs-toc-heading-level-1"><a href="#pre-defined-payrolls">Pre-defined Payrolls</a>
                                <ul class="betterdocs-toc-list-level-2">
                                    <li class="betterdocs-toc-heading-level-2"><a href="#download-payroll-files">Download Payroll Files</a></li>
                                </ul>
                            </li>
                            <li class="betterdocs-toc-heading-level-1"><a href="#import-payrolls">Import Payrolls</a></li>
                        </ul>
                    </div>
                    <div id="betterdocs-single-content" class="betterdocs-content">
                        <h1 id="pre-defined-payrolls" class="betterdocs-content-heading" id="pre-defined-payrolls">Pre-defined Payrolls <a href="#pre-defined-payrolls" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/import-export-payrolls/#pre-defined-payrolls" data-title="Copy URL">#</a></h1>
                        <p>IceHrm team has already created a few sample payrolls which you can import and use to generate or study the payroll creation process.</p>
                        <h2 id="download-payroll-files" class="betterdocs-content-heading" id="download-payroll-files">Download Payroll Files <a href="#download-payroll-files" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/import-export-payrolls/#download-payroll-files" data-title="Copy URL">#</a></h2>
                        <ul>
                            <li><a href="https://s3.amazonaws.com/icehrm/payroll/Sample-Country-Payroll.txt">Sample Payroll Setup</a></li>
                            <li><a href="https://s3.amazonaws.com/icehrm/payroll/SriLanka-Payroll.txt">Sri Lanka Payroll Setup</a></li>
                            <li><a href="https://s3.amazonaws.com/icehrm/payroll/Ghana-Payroll.txt">Ghana Payroll Setup</a></li>
                        </ul>
                        <h1 id="import-payrolls" class="betterdocs-content-heading" id="import-payrolls">Import Payrolls <a href="#import-payrolls" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/import-export-payrolls/#import-payrolls" data-title="Copy URL">#</a></h1>
                        <ul>
                            <li>Goto System -> Data module</li>
                            <li>Select &#8220;Data Import Files&#8221; Tab</li>
                            <li>Press Add New button</li>
                        </ul>
                        <figure class="wp-block-image size-large"><img decoding="async" width="1024" height="346" src="https://icehrm.com/explore/wp-content/uploads/2022/02/Screenshot-from-2022-02-09-16-17-59-1-1024x346.png" alt="" class="wp-image-1794" srcset="https://icehrm.com/explore/wp-content/uploads/2022/02/Screenshot-from-2022-02-09-16-17-59-1-1024x346.png 1024w, https://icehrm.com/explore/wp-content/uploads/2022/02/Screenshot-from-2022-02-09-16-17-59-1-300x101.png 300w, https://icehrm.com/explore/wp-content/uploads/2022/02/Screenshot-from-2022-02-09-16-17-59-1-768x260.png 768w, https://icehrm.com/explore/wp-content/uploads/2022/02/Screenshot-from-2022-02-09-16-17-59-1-600x203.png 600w, https://icehrm.com/explore/wp-content/uploads/2022/02/Screenshot-from-2022-02-09-16-17-59-1.png 1243w" sizes="(max-width: 1024px) 100vw, 1024px" /></figure>
                        <ul>
                            <li>Give a meaningful name and select &#8220;Payroll Data Import&#8221; as Data Import Definitions.</li>
                            <li>Select the file you downloaded using above links</li>
                            <li>Save</li>
                            <li>From the list client on &#8220;Process&#8221; button</li>
                        </ul>
                        <figure class="is-layout-flex wp-block-gallery-1 wp-block-gallery has-nested-images columns-default is-cropped">
                            <figure class="wp-block-image size-large"><img decoding="async" loading="lazy" width="1024" height="35" data-id="1795" src="https://icehrm.com/explore/wp-content/uploads/2022/02/Screenshot-from-2022-02-09-16-28-42-1024x35.png" alt="" class="wp-image-1795" srcset="https://icehrm.com/explore/wp-content/uploads/2022/02/Screenshot-from-2022-02-09-16-28-42-1024x35.png 1024w, https://icehrm.com/explore/wp-content/uploads/2022/02/Screenshot-from-2022-02-09-16-28-42-300x10.png 300w, https://icehrm.com/explore/wp-content/uploads/2022/02/Screenshot-from-2022-02-09-16-28-42-768x26.png 768w, https://icehrm.com/explore/wp-content/uploads/2022/02/Screenshot-from-2022-02-09-16-28-42-1536x52.png 1536w, https://icehrm.com/explore/wp-content/uploads/2022/02/Screenshot-from-2022-02-09-16-28-42-600x20.png 600w, https://icehrm.com/explore/wp-content/uploads/2022/02/Screenshot-from-2022-02-09-16-28-42.png 1618w" sizes="(max-width: 1024px) 100vw, 1024px" /></figure>
                        </figure>
                    </div>
                </div>
                <div class="betterdocs-entry-footer">
                    <div class="feedback-update-form">
                        ...
                        <div class="update-date">
                            Updated on February 9, 2022 </div>
                    </div>
                </div>
                <div class="docs-navigation"><a href="https://icehrm.com/explore/docs/payroll-management/" rel="prev"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
                        ...
                        </svg> Payroll Management</a><a href="https://icehrm.com/explore/docs/building-payroll-for-india/" rel="next">Building Payroll for India <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
