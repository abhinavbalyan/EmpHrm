            ...
            <div id="betterdocs-single-main" class="docs-single-main">
                    ...
                    <div class="docs-single-title">
                        <nav id="betterdocs-breadcrumb" class="betterdocs-breadcrumb" xmlns:v="http://rdf.data-vocabulary.org/#">
                            <ul class="betterdocs-breadcrumb-list">
                                ...
                                <li class="betterdocs-breadcrumb-item item-current item-2377 current"><span>Leave Management FAQ</span></li>
                            </ul>
                        </nav>
                        <h1 id="betterdocs-entry-title" class="betterdocs-entry-title">Leave Management FAQ</h1>
                    </div>
                </header>
                <div class="betterdocs-entry-content">
                        ...
                        <ul class="toc-list betterdocs-hierarchial-toc">
                            <li class="betterdocs-toc-heading-level-3"><a href="#leave-paid-time-off-management">Leave/Paid Time Off Management</a>
                                <ul class="betterdocs-toc-list-level-4">
                                    <li class="betterdocs-toc-heading-level-4"><a href="#how-to-allocate-160-hours-instead-of-days-in-leave-management-module">How to allocate 160 hours instead of days in the leave management module?</a></li>
                    ...
                    <div id="betterdocs-single-content" class="betterdocs-content">
                        <h3 id="leave-paid-time-off-management" class="betterdocs-content-heading" id="leave-paid-time-off-management">Leave/Paid Time Off Management <a href="#leave-paid-time-off-management" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/leave-management-faq/#leave-paid-time-off-management" data-title="Copy URL">#</a></h3>
                        <h4 id="how-to-allocate-160-hours-instead-of-days-in-leave-management-module" class="betterdocs-content-heading" id="how-to-allocate-160-hours-instead-of-days-in-leave-management-module">How to allocate 160 hours instead of days in the leave management module? <a href="#how-to-allocate-160-hours-instead-of-days-in-leave-management-module" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/leave-management-faq/#how-to-allocate-160-hours-instead-of-days-in-leave-management-module" data-title="Copy URL">#</a></h4>
                        ...
                        <h4 id="how-to-compensate-an-employee-with-paid-time-off" class="betterdocs-content-heading" id="how-to-compensate-an-employee-with-paid-time-off">How to compensate an employee with Paid time off? <a href="#how-to-compensate-an-employee-with-paid-time-off" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/leave-management-faq/#how-to-compensate-an-employee-with-paid-time-off" data-title="Copy URL">#</a></h4>
                ...
                <div class="docs-navigation"><a href="https://icehrm.com/explore/docs/understand-the-leave-calculation/" rel="prev"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
                        ...
                        </svg> Understand the Leave Calculation</a></div>
