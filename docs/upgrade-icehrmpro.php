                    ...
                    <div class="docs-single-title">
                        <nav id="betterdocs-breadcrumb" class="betterdocs-breadcrumb" xmlns:v="http://rdf.data-vocabulary.org/#">
                            <ul class="betterdocs-breadcrumb-list">
                                ...
                                <li class="betterdocs-breadcrumb-item item-current item-1194 current"><span>Upgrade IceHrmPro</span></li>
                            </ul>
                        </nav>
                        <h1 id="betterdocs-entry-title" class="betterdocs-entry-title">Upgrade IceHrmPro</h1>
                    </div>
                </header>
                <div class="betterdocs-entry-content">
                    ...
                    <div class="betterdocs-toc toc-list-number">
                        ...
                        <ul class="toc-list betterdocs-hierarchial-toc">
                            <li class="betterdocs-toc-heading-level-1"><a href="#0-toc-title">Upgrade IceHrm Pro</a></li>
                            <li class="betterdocs-toc-heading-level-1"><a href="#upgrade-icehrm-open-source-to-icehrmpro">Upgrade IceHrm Open Source to IceHrmPro</a></li>
                        </ul>
                    </div>
                    <div id="betterdocs-single-content" class="betterdocs-content">
                        <h1 class="betterdocs-content-heading" id="0-toc-title">Upgrade IceHrm Pro <a href="#0-toc-title" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/upgrade-icehrmpro/#0-toc-title" data-title="Copy URL">#</a></h1>
                        <ul>
                            <li>Download IceHrmPro release file</li>
                            <li>Extract the latest IceHrmPro release (zip) file</li>
                            <li>When you extract IceHrmPro.zip you should see a new directory created with IceHrm current version</li>
                        </ul>
                        <figure class="wp-block-image"><img decoding="async" src="https://files.gitbook.com/v0/b/gitbook-28427.appspot.com/o/assets%2F-LSTAqbcVhk-wxBWPiuv%2F-MkWezwvGCPEUAmlIjig%2F-MkWgS7oAAMA3OiSw_JO%2FScreenshot%202021-09-26%20at%2012.40.58.png?alt=media&amp;token=8ee45fe7-4fa3-4e22-a88a-48f5b040eb1a" alt="" /></figure>
                        <p></p>
                        <ul>
                            <li>Go into &#8220;icehrm_&lt;version&gt;&#8221; directory. Locate &#8220;core&#8221; and &#8220;web&#8221; directories, and replace the &#8220;web&#8221; and &#8220;core&#8221; directories in your new installation.</li>
                        </ul>
                        <figure class="wp-block-image is-resized"><img decoding="async" loading="lazy" src="https://files.gitbook.com/v0/b/gitbook-28427.appspot.com/o/assets%2F-LSTAqbcVhk-wxBWPiuv%2F-MkWezwvGCPEUAmlIjig%2F-MkWizxq5dH6_1r3fLkC%2FScreenshot%202021-09-26%20at%2012.51.56.png?alt=media&amp;token=fc2ba42a-e7c0-4448-9d66-2db0ccec0f9c" alt="" width="600" height="500" /></figure>
                        <p><strong><mark style="background-color:rgba(0, 0, 0, 0)" class="has-inline-color has-theme-palette-3-color">** Note: If you are upgrading to v32.2.0 make sure to copy icehrm/app/apply directory from the release file to your installation.</mark></strong></p>
                        <h1 id="upgrade-icehrm-open-source-to-icehrmpro" class="betterdocs-content-heading" id="upgrade-icehrm-open-source-to-icehrmpro">Upgrade IceHrm Open Source to IceHrmPro <a href="#upgrade-icehrm-open-source-to-icehrmpro" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/upgrade-icehrmpro/#upgrade-icehrm-open-source-to-icehrmpro" data-title="Copy URL">#</a></h1>
                        <p><em>If you are already using Icehrm open source, and purchased IceHrmPro. You can upgrade the installation without losing your data.</em></p>
                        <ul>
                            <li>Download IceHrmPro release file</li>
                            <li>Extract the latest IceHrmPro release (zip) file</li>
                            <li>When you extract IceHrmPro.zip you should see a new directory created with IceHrm current version</li>
                        ...
                        <p></p>
                        <ul>
                            <li>Copy icehrm.key file from the new release into your icehrm/app directory.</li>
                        </ul>
                        <figure class="wp-block-image"><img decoding="async" src="https://files.gitbook.com/v0/b/gitbook-28427.appspot.com/o/assets%2F-LSTAqbcVhk-wxBWPiuv%2F-MkWezwvGCPEUAmlIjig%2F-MkWkCfE_DInw26bHu0-%2FScreenshot%202021-09-26%20at%2012.57.28.png?alt=media&amp;token=7dfe46a8-6126-48b8-8171-be585ce1a6b8" alt="" /></figure>
                    </div>
                </div>
                <div class="betterdocs-entry-footer">
                    <div class="feedback-update-form">
                        ...
                        <div class="update-date">
                            Updated on October 18, 2022 </div>
                    </div>
                </div>
                <div class="docs-navigation"><a href="https://icehrm.com/explore/docs/faq/" rel="next">FAQ <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
