            ...
            <div id="betterdocs-single-main" class="docs-single-main">
                    ...
                    <div class="docs-single-title">
                        <nav id="betterdocs-breadcrumb" class="betterdocs-breadcrumb" xmlns:v="http://rdf.data-vocabulary.org/#">
                            <ul class="betterdocs-breadcrumb-list">
                                ...
                                <li class="betterdocs-breadcrumb-item item-current item-1212 current"><span>Adding Entries to DB</span></li>
                            </ul>
                        </nav>
                        <h1 id="betterdocs-entry-title" class="betterdocs-entry-title">Adding Entries to DB</h1>
                    </div>
                </header>
                <div class="betterdocs-entry-content">
                        ...
                        <ul class="toc-list betterdocs-hierarchial-toc">
                            <li class="betterdocs-toc-heading-level-1"><a href="#introduction">Introduction</a>
                                <ul class="betterdocs-toc-list-level-2">
                                    <li class="betterdocs-toc-heading-level-2"><a href="#add-a-model-class">Add a Model Class</a></li>
                                    <li class="betterdocs-toc-heading-level-2"><a href="#update-extension-include-file">Update Extension Include File</a></li>
                                    <li class="betterdocs-toc-heading-level-2"><a href="#create-a-random-task">Create a Random Task</a></li>
                    ...
                    <div id="betterdocs-single-content" class="betterdocs-content">
                        <h1 id="introduction" class="betterdocs-content-heading" id="introduction">Introduction <a href="#introduction" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/adding-entries-to-db/#introduction" data-title="Copy URL">#</a></h1>
                        <p>Let&#8217;s check how we can add data into the newly created table.</p>
                        <h2 id="add-a-model-class" class="betterdocs-content-heading" id="add-a-model-class">Add a Model Class <a href="#add-a-model-class" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/adding-entries-to-db/#add-a-model-class" data-title="Copy URL">#</a></h2>
                        <p>In order to communicate with the database, you need a model. IceHrm uses AdoDB as the ORM. But it provides an abstraction layer on top of AdoDB.</p>
...
class Task extends BaseModel
{
    public $table = 'Tasks';
                        ...
                        <h2 id="update-extension-include-file" class="betterdocs-content-heading" id="update-extension-include-file">Update Extension Include File <a href="#update-extension-include-file" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/adding-entries-to-db/#update-extension-include-file" data-title="Copy URL">#</a></h2>
                        <p><strong>tasks.php</strong></p>
                        <pre class="wp-block-code"><code>&lt;?php
require_once __DIR__.'/src/Tasks/Extension.php';
require_once __DIR__.'/src/Tasks/Migration.php';
require_once __DIR__.'/src/Tasks/Model/Task.php';</code></pre>
                        <h2 id="create-a-random-task" class="betterdocs-content-heading" id="create-a-random-task">Create a Random Task <a href="#create-a-random-task" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/adding-entries-to-db/#create-a-random-task" data-title="Copy URL">#</a></h2>
                        <p>Just for testing we will create a new task on the view file itself, and print it on screen.</p>
                        <h2 id="web-index.php" class="betterdocs-content-heading" id="web-index.php">web/index.php <a href="#web-index.php" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/adding-entries-to-db/#web-index.php" data-title="Copy URL">#</a></h2>
                        <pre class="wp-block-code"><code>&lt;?php
...
var_dump($taskFromDB);</code></pre>
                        <p>Please find all the code up to this point here: <a href="https://github.com/gamonoid/icehrm/tree/extension-example-models/extensions/tasks">https://github.com/gamonoid/icehrm/tree/extension-example-models/extensions/tasks</a></p>
                        <figure class="wp-block-image size-large"><img decoding="async" width="1024" height="534" src="https://icehrm.com/explore/wp-content/uploads/2021/11/code-1024x534.png" alt="" class="wp-image-1213" srcset="https://icehrm.com/explore/wp-content/uploads/2021/11/code-1024x534.png 1024w, https://icehrm.com/explore/wp-content/uploads/2021/11/code-300x156.png 300w, https://icehrm.com/explore/wp-content/uploads/2021/11/code-768x401.png 768w, https://icehrm.com/explore/wp-content/uploads/2021/11/code-1536x801.png 1536w, https://icehrm.com/explore/wp-content/uploads/2021/11/code-2048x1068.png 2048w, https://icehrm.com/explore/wp-content/uploads/2021/11/code-600x313.png 600w" sizes="(max-width: 1024px) 100vw, 1024px" /></figure>
                    </div>
                </div>
                ...
                <div class="docs-navigation"><a href="https://icehrm.com/explore/docs/add-a-db-migration/" rel="prev"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
