            ...
            <div id="betterdocs-single-main" class="docs-single-main">
                    ...
                    <div class="docs-single-title">
                        <nav id="betterdocs-breadcrumb" class="betterdocs-breadcrumb" xmlns:v="http://rdf.data-vocabulary.org/#">
                            <ul class="betterdocs-breadcrumb-list">
                                ...
                                <li class="betterdocs-breadcrumb-item item-current item-2466 current"><span>Approving a Training Session</span></li>
                            </ul>
                        </nav>
                        <h1 id="betterdocs-entry-title" class="betterdocs-entry-title">Approving a Training Session</h1>
                    </div>
                </header>
                <div class="betterdocs-entry-content">
                    ...
                    <div id="betterdocs-single-content" class="betterdocs-content">
                        ...
                        <figure class="wp-block-image size-full is-resized"><img decoding="async" src="https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-47.png" alt="" class="wp-image-2467" width="690" height="383" srcset="https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-47.png 900w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-47-300x167.png 300w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-47-768x427.png 768w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-47-600x333.png 600w" sizes="(max-width: 690px) 100vw, 690px" /></figure>
                ...
                <div class="docs-navigation"><a href="https://icehrm.com/explore/docs/subscribing-to-a-training-session/" rel="prev"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
                        ...
                        </svg> Subscribing To a Training Session</a></div>
