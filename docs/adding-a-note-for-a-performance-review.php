    ...
    <div class="betterdocs-single-wraper betterdocs-single-bg betterdocs-single-layout1">
        ...
        <div class="betterdocs-content-area">
            ...
            <div id="betterdocs-single-main" class="docs-single-main">
                    ...
                    <div class="docs-single-title">
                        <nav id="betterdocs-breadcrumb" class="betterdocs-breadcrumb" xmlns:v="http://rdf.data-vocabulary.org/#">
                            <ul class="betterdocs-breadcrumb-list">
                                ...
                                <li class="betterdocs-breadcrumb-item item-current item-2537 current"><span>Adding a Note For a Performance Review</span></li>
                            </ul>
                        </nav>
                        <h1 id="betterdocs-entry-title" class="betterdocs-entry-title">Adding a Note For a Performance Review</h1>
                    </div>
                </header>
                <div class="betterdocs-entry-content">
                    ...
                    <div id="betterdocs-single-content" class="betterdocs-content">
                        <ol>
                            ...
                            <li>Go to the Performance Review module on Dashboard</li>
                            <li>Under the <strong>Performance Review</strong> tab, employees’ reviews will be displayed.</li>
                            <li>Click on the<strong> Edit </strong>button.</li>
                        </ol>
                        <figure class="wp-block-image size-full"><img decoding="async" width="900" height="500" src="https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-64.png" alt="" class="wp-image-2538" srcset="https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-64.png 900w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-64-300x167.png 300w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-64-768x427.png 768w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-64-600x333.png 600w" sizes="(max-width: 900px) 100vw, 900px" /></figure>
                ...
                <div class="docs-navigation"><a href="https://icehrm.com/explore/docs/viewing-peer-feedback-as-an-employee/" rel="prev"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
                        ...
                        </svg> Viewing Peer Feedback as an Employee</a></div>
