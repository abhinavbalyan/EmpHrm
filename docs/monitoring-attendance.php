            ...
            <div id="betterdocs-single-main" class="docs-single-main">
                    ...
                    <div class="docs-single-title">
                        <nav id="betterdocs-breadcrumb" class="betterdocs-breadcrumb" xmlns:v="http://rdf.data-vocabulary.org/#">
                            <ul class="betterdocs-breadcrumb-list">
                                ...
                                <li class="betterdocs-breadcrumb-item item-current item-2581 current"><span>Monitoring Attendance</span></li>
                            </ul>
                        </nav>
                        <h1 id="betterdocs-entry-title" class="betterdocs-entry-title">Monitoring Attendance</h1>
                    </div>
                </header>
                <div class="betterdocs-entry-content">
                    ...
                    <div id="betterdocs-single-content" class="betterdocs-content">
                        <p>Attendance details of employees can be viewed/edited via the <strong>Manage -> Attendance</strong> module. Admin users can view all employee attendance while Managers can view attendance data for subordinates (direct reports).</p>
                        <figure class="wp-block-image size-full"><img decoding="async" width="900" height="300" src="https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-900-×-300px-21.png" alt="" class="wp-image-2582" srcset="https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-900-×-300px-21.png 900w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-900-×-300px-21-300x100.png 300w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-900-×-300px-21-768x256.png 768w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-900-×-300px-21-600x200.png 600w" sizes="(max-width: 900px) 100vw, 900px" /></figure>
                        <p><em>Once an employee has completed 8 hours the time will turn green. Note that Icehrm considers 8 hours as a working day and if an employee passes works more than 8 hours, the remaining hours will be considered overtime hours.</em></p>
                ...
                <div class="docs-navigation"><a href="https://icehrm.com/explore/docs/recording-attendance/" rel="prev"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
                        ...
                        </svg> Recording Attendance</a><a href="https://icehrm.com/explore/docs/uploading-attendance-data/" rel="next">Uploading Attendance Data <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
