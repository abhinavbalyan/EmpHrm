            ...
            <div id="betterdocs-single-main" class="docs-single-main">
                    ...
                    <div class="docs-single-title">
                        <nav id="betterdocs-breadcrumb" class="betterdocs-breadcrumb" xmlns:v="http://rdf.data-vocabulary.org/#">
                            <ul class="betterdocs-breadcrumb-list">
                                ...
                                <li class="betterdocs-breadcrumb-item item-current item-2502 current"><span>Pre-Approving Expenses and Reporting</span></li>
                            </ul>
                        </nav>
                        <h1 id="betterdocs-entry-title" class="betterdocs-entry-title">Pre-Approving Expenses and Reporting</h1>
                    </div>
                </header>
                <div class="betterdocs-entry-content">
                    ...
                    <div id="betterdocs-single-content" class="betterdocs-content">
                        ...
                        <figure class="wp-block-image size-full is-resized"><img decoding="async" src="https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-54.png" alt="" class="wp-image-2503" width="753" height="418" srcset="https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-54.png 900w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-54-300x167.png 300w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-54-768x427.png 768w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-54-600x333.png 600w" sizes="(max-width: 753px) 100vw, 753px" /></figure>
                        <h1 id="reporting" class="betterdocs-content-heading" id="reporting">Reporting <a href="#reporting" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/pre-approving-expenses-and-reporting/#reporting" data-title="Copy URL">#</a></h1>
                ...
                <div class="docs-navigation"><a href="https://icehrm.com/explore/docs/approving-an-expense-as-an-admin-manager/" rel="prev"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
                        ...
                        </svg> Approving an Expense As an Admin/Manager</a></div>
