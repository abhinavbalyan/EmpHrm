    ...
    <div class="betterdocs-single-wraper betterdocs-single-bg betterdocs-single-layout1">
        ...
        <div class="betterdocs-content-area">
            ...
            <div id="betterdocs-single-main" class="docs-single-main">
                    ...
                    <div class="docs-single-title">
                        <nav id="betterdocs-breadcrumb" class="betterdocs-breadcrumb" xmlns:v="http://rdf.data-vocabulary.org/#">
                            <ul class="betterdocs-breadcrumb-list">
                                ...
                                <li class="betterdocs-breadcrumb-item item-current item-2421 current"><span>Setting Up Recruitment Module</span></li>
                            </ul>
                        </nav>
                        <h1 id="betterdocs-entry-title" class="betterdocs-entry-title">Setting Up Recruitment Module</h1>
                    </div>
                </header>
                <div class="betterdocs-entry-content">
                    ...
                    <div class="betterdocs-toc toc-list-number">
                        ...
                        <ul class="toc-list betterdocs-hierarchial-toc">
                            <li class="betterdocs-toc-heading-level-1"><a href="#recruitment">Recruitment</a>
                                <ul class="betterdocs-toc-list-level-2">
                                    <li class="betterdocs-toc-heading-level-2"><a href="#recruitment-setup">Recruitment Setup</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
                    <div id="betterdocs-single-content" class="betterdocs-content">
                        <p>The Recruitment module in IceHRm automates and manages your organization’s recruitment and staffing operations, simplifying the process from start to finish.</p>
                        <p>The recruitment<strong>&nbsp;module can be used to:</strong></p>
                        <ul>
                            <li>Post jobs</li>
                            <li>Let candidates apply for these jobs</li>
                            <li>Schedule interviews</li>
                            <li>Track candidate progress with notes</li>
                            <li>Share job links with Linkedin, Facebook, Twitter </li>
                        </ul>
                        <h1 id="recruitment" class="betterdocs-content-heading" id="recruitment">Recruitment <a href="#recruitment" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/setting-up-recruitment-module/#recruitment" data-title="Copy URL">#</a></h1>
                        <p>The IceHrm recruitment module is a set of tools designed to manage the recruitment process. As we all know recruitment is competitive, especially for those with much-needed technical skills, and is stimulating interest in sophisticated recruitment systems. So the IceHrm Recruitment module has been designed to improve the efficiency of recruiters and job seekers.</p>
                        <p><strong>Under IceHrm Recruitment, you can find three modules as below;</strong></p>
                        <p><strong>Recruitment Set up</strong>&nbsp;— This is helpful for you to prepare the job advertisement. Under this category, you can edit the employment types, edit experience levels, edit job functions and edit educational levels based on your requirements.</p>
                        <p><strong>Job Postings</strong>&nbsp;— This is the module that you can use to create a job advertisement and publish it on social media.</p>
                        <p><strong>Candidates </strong>— Under this, you can store the details of the candidates who have applied for each job advertisements.</p>
                        <h2 id="recruitment-setup" class="betterdocs-content-heading" id="recruitment-setup">Recruitment Setup <a href="#recruitment-setup" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/setting-up-recruitment-module/#recruitment-setup" data-title="Copy URL">#</a></h2>
                        <p>Using recruitment setup you can add/edit Employment Types, Experience levels, Job Functions, Education Levels, and Benefits. All this information will be used when posting a job.</p>
                        <p></p>
                    </div>
                </div>
                ...
                <div class="docs-navigation"><a href="https://icehrm.com/explore/docs/adding-a-new-employment-type/" rel="next">Adding a New Employment Type <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
