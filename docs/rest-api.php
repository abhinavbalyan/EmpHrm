                    ...
                    <div class="docs-single-title">
                        <nav id="betterdocs-breadcrumb" class="betterdocs-breadcrumb" xmlns:v="http://rdf.data-vocabulary.org/#">
                            <ul class="betterdocs-breadcrumb-list">
                                ...
                                <li class="betterdocs-breadcrumb-item item-current item-1179 current"><span>Rest API</span></li>
                            </ul>
                        </nav>
                        <h1 id="betterdocs-entry-title" class="betterdocs-entry-title">Rest API</h1>
                    </div>
                </header>
                <div class="betterdocs-entry-content">
                    ...
                    <div class="betterdocs-toc toc-list-number">
                        ...
                        <ul class="toc-list betterdocs-hierarchial-toc">
                            <li class="betterdocs-toc-heading-level-1"><a href="#setting-up-icehrm-open-source-and-pro-rest-api-nginx">Setting up IceHrm Open Source and Pro REST Api - Nginx</a></li>
                            <li class="betterdocs-toc-heading-level-1"><a href="#setting-up-icehrm-open-source-and-pro-rest-api-apache-xampp-wampp">Setting up IceHrm Open Source and Pro REST Api - Apache (XAMPP, WAMPP)</a></li>
                            <li class="betterdocs-toc-heading-level-1"><a href="#testing-rest-api">Testing Rest Api</a></li>
                            <li class="betterdocs-toc-heading-level-1"><a href="#using-rest-api-with-open-source-and-icehrmpro">Using REST Api with Open Source and IceHrmPro</a></li>
                        </ul>
                    </div>
                    <div id="betterdocs-single-content" class="betterdocs-content">
                        <p>Currently, Icehrm exposes employee details and attendance data via the REST API.</p>
                        <p>Full API Documentation can be found here: <a href="https://icehrm.docs.apiary.io/#">https://icehrm.docs.apiary.io/#</a></p>
                        <h1 id="setting-up-icehrm-open-source-and-pro-rest-api-nginx" class="betterdocs-content-heading" id="setting-up-icehrm-open-source-and-pro-rest-api-nginx">Setting up IceHrm Open Source and Pro REST Api &#8211; Nginx <a href="#setting-up-icehrm-open-source-and-pro-rest-api-nginx" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/rest-api/#setting-up-icehrm-open-source-and-pro-rest-api-nginx" data-title="Copy URL">#</a></h1>
                        <p>IceHrm includes a REST API but it needs to be configured via web server configurations.</p>
                        <p>Basically, all the requests coming to icehrm.url/app/api/ should be redirected to icehrm.url/app/index.php</p>
                        <p>For example, if you are using Nginx web server you need to add the following location block inside your sever block in the Nginx config file for your site.</p>
                        <pre class="wp-block-code"><code>location /app/api/ {
    try_files $uri /app/api/index.php?/$uri&amp;$args;
}</code></pre>
                        <p>If IceHrm is not loaded from web root, for example, if your Icehrm url is <strong>your-icehrm-url.com/icehrm</strong> instead of <strong>your-icehrm-url.com</strong> you should add any directory in relative path to location block as in the following example</p>
                        <pre class="wp-block-code"><code>location /icehrm/app/api/ {
    try_files $uri /icehrm/app/api/index.php?/$uri&amp;$args;
}</code></pre>
                        <h1 id="setting-up-icehrm-open-source-and-pro-rest-api-apache-xampp-wampp" class="betterdocs-content-heading" id="setting-up-icehrm-open-source-and-pro-rest-api-apache-xampp-wampp">Setting up IceHrm Open Source and Pro REST Api &#8211; Apache (XAMPP, WAMPP) <a href="#setting-up-icehrm-open-source-and-pro-rest-api-apache-xampp-wampp" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/rest-api/#setting-up-icehrm-open-source-and-pro-rest-api-apache-xampp-wampp" data-title="Copy URL">#</a></h1>
                        <p>For Apache web server, we have already included a .htaccess file under icehrm/app/api. This will redirect the API request properly.</p>
                        <h1 id="testing-rest-api" class="betterdocs-content-heading" id="testing-rest-api">Testing Rest Api <a href="#testing-rest-api" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/rest-api/#testing-rest-api" data-title="Copy URL">#</a></h1>
                        <ul>
                            <li>First you should enable REST api via Settings -&gt; Other -&gt; Enable REST Api setting</li>
                            <li>Visit <strong>your-icehrm-url.com/app/api/echo</strong></li>
                            <li>This should output an echo with a random number</li>
                        </ul>
                        <h1 id="using-rest-api-with-open-source-and-icehrmpro" class="betterdocs-content-heading" id="using-rest-api-with-open-source-and-icehrmpro">Using REST Api with Open Source and IceHrmPro <a href="#using-rest-api-with-open-source-and-icehrmpro" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/rest-api/#using-rest-api-with-open-source-and-icehrmpro" data-title="Copy URL">#</a></h1>
                        <p>Your API URL base will be <strong>http://your-icehrm-url.com/app/api.</strong> If you want to call employees/me, you should send a request to <strong>http://your-icehrm-url.com/app/api/employees/me</strong>.</p>
                    </div>
                </div>
                <div class="betterdocs-entry-footer">
                    <div class="feedback-update-form">
                        ...
                        <div class="update-date">
                            Updated on January 30, 2023 </div>
                    </div>
                </div>
                <div class="docs-navigation"><a href="https://icehrm.com/explore/docs/using-ldap/" rel="next">Using LDAP <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
