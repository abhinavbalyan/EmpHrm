            ...
            <div id="betterdocs-single-main" class="docs-single-main">
                    ...
                    <div class="docs-single-title">
                        <nav id="betterdocs-breadcrumb" class="betterdocs-breadcrumb" xmlns:v="http://rdf.data-vocabulary.org/#">
                            <ul class="betterdocs-breadcrumb-list">
                                ...
                                <li class="betterdocs-breadcrumb-item item-current item-1174 current"><span>Company Assets</span></li>
                            </ul>
                        </nav>
                        <h1 id="betterdocs-entry-title" class="betterdocs-entry-title">Company Assets</h1>
                    </div>
                </header>
                <div class="betterdocs-entry-content">
                    ...
                    <div id="betterdocs-single-content" class="betterdocs-content">
                        <p>Using the IceHrm Company Asset module you can record all your company assets, assign them to the employees and manage them effectively.</p>
                        <p>First using Asset Type, you can create all the Asset Types in your organization.</p>
                        <p>Go to <strong>Manage -> Company Assets -> Asset Type.</strong></p>
                        <figure class="wp-block-image"><img decoding="async" src="https://files.gitbook.com/v0/b/gitbook-28427.appspot.com/o/assets%2F-LSTAqbcVhk-wxBWPiuv%2F-MXlSTEQ0jLJpVJXsxEg%2F-MXldh9RArzGuszXmv8I%2Fimage.png?alt=media&amp;token=60e710d3-e5cb-4092-afcd-f82831c19b92" alt="" /></figure>
                        <p>Then, you can assign them to the employees under the Company Asset tab.</p>
                        <figure class="wp-block-image size-large"><img decoding="async" loading="lazy" width="1024" height="418" src="https://icehrm.com/explore/wp-content/uploads/2021/11/assets-1024x418.png" alt="" class="wp-image-1175" srcset="https://icehrm.com/explore/wp-content/uploads/2021/11/assets-1024x418.png 1024w, https://icehrm.com/explore/wp-content/uploads/2021/11/assets-300x122.png 300w, https://icehrm.com/explore/wp-content/uploads/2021/11/assets-768x314.png 768w, https://icehrm.com/explore/wp-content/uploads/2021/11/assets-1536x627.png 1536w, https://icehrm.com/explore/wp-content/uploads/2021/11/assets-600x245.png 600w, https://icehrm.com/explore/wp-content/uploads/2021/11/assets.png 1896w" sizes="(max-width: 1024px) 100vw, 1024px" /></figure>
                    </div>
                </div>
                ...
                <div class="docs-navigation"><a href="https://icehrm.com/explore/docs/reporting/" rel="prev"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
                        ...
                        </svg> Reporting</a><a href="https://icehrm.com/explore/docs/data-import/" rel="next">Data Import <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
