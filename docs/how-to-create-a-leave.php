    ...
    <div class="betterdocs-single-wraper betterdocs-single-bg betterdocs-single-layout1">
        ...
        <div class="betterdocs-content-area">
            ...
            <div id="betterdocs-single-main" class="docs-single-main">
                    ...
                    <div class="docs-single-title">
                        <nav id="betterdocs-breadcrumb" class="betterdocs-breadcrumb" xmlns:v="http://rdf.data-vocabulary.org/#">
                            <ul class="betterdocs-breadcrumb-list">
                                ...
                                <li class="betterdocs-breadcrumb-item item-current item-2353 current"><span>Creating a Leave Group</span></li>
                            </ul>
                        </nav>
                        <h1 id="betterdocs-entry-title" class="betterdocs-entry-title">Creating a Leave Group</h1>
                    </div>
                </header>
                <div class="betterdocs-entry-content">
                    ...
                    <div id="betterdocs-single-content" class="betterdocs-content">
                        ...
                        <ol>
                            ...
                            <li>Selectively allow some leave types only to a group of employees (for example you can assign Maternity leaves only to female employees).</li>
                        </ol>
                        <p>In order to do this:</p>
                        <p>● First, create the leave group under&nbsp;<strong>Manage -&gt; Leave -&gt; Leave Groups -&gt; Edit Leave Groups.</strong></p>
                        <figure class="wp-block-image size-full"><img decoding="async" width="900" height="500" src="https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-16.png" alt="" class="wp-image-2354" srcset="https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-16.png 900w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-16-300x167.png 300w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-16-768x427.png 768w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-16-600x333.png 600w" sizes="(max-width: 900px) 100vw, 900px" /></figure>
                ...
                <div class="docs-navigation"><a href="https://icehrm.com/explore/docs/how-to-view-employee-leaves/" rel="prev"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
                        ...
                        </svg> Viewing Employee Leave Requests</a><a href="https://icehrm.com/explore/docs/how-to-create-a-leave-rule/" rel="next">Creating a Leave Rule <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
