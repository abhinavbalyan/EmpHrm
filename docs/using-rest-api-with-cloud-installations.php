...
<div id="inner-wrap" class="wrap hfeed kt-clear">
                    ...
                    <div class="docs-single-title">
                        <nav id="betterdocs-breadcrumb" class="betterdocs-breadcrumb" xmlns:v="http://rdf.data-vocabulary.org/#">
                            <ul class="betterdocs-breadcrumb-list">
                                ...
                                <li class="betterdocs-breadcrumb-item item-current item-3006 current"><span>Using REST Api with Cloud installations</span></li>
                            </ul>
                        </nav>
                        <h1 id="betterdocs-entry-title" class="betterdocs-entry-title">Using REST Api with Cloud installations</h1>
                    </div>
                </header>
                <div class="betterdocs-entry-content">
                    ...
                    <div class="betterdocs-toc toc-list-number">
                        ...
                        <ul class="toc-list betterdocs-hierarchial-toc">
                            <li class="betterdocs-toc-heading-level-2"><a href="#0-toc-title">Making the First Api call - Cloud</a></li>
                        </ul>
                    </div>
                    <div id="betterdocs-single-content" class="betterdocs-content">
                        <p>First, you should enable REST API via Settings -&gt; Other -&gt; Enable REST API setting.</p>
                        <p>IceHrm uses OAuth 2.0 bearer authentication. So you have to send the bearer token with every request. Each Icehrm user can find their auth token by opening Basic Information -> Personal Information -> Api Access (tab).</p>
                        <figure class="wp-block-image"><img decoding="async" src="https://files.gitbook.com/v0/b/gitbook-28427.appspot.com/o/assets%2F-LSTAqbcVhk-wxBWPiuv%2F-LSTBj3Mn8gXVQaLg9Zr%2F-LSTBjrlZ8moRTl530Y8%2FScreen%20Shot%202018-03-15%20at%201.07.05%20AM.png?generation=1543473660206578&amp;alt=media" alt="" /></figure>
                        <h2 class="betterdocs-content-heading" id="0-toc-title">Making the First Api call &#8211; Cloud <a href="#0-toc-title" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/using-rest-api-with-cloud-installations/#0-toc-title" data-title="Copy URL">#</a></h2>
                        <p>If your Icehrm instance name is test1 (https://test1.icehrm.com), your API URL will be</p>
                        <ul>
                            <li><a href="https://icehrm.com/api/test1">https://icehrm.com/api/test1</a></li>
                        </ul>
                        <p>Then according to <a href="https://icehrm.docs.apiary.io/#">https://icehrm.docs.apiary.io/#</a> you can view your own data by sending a GET request to</p>
                        <ul>
                            <li><a href="https://icehrm.com/api/test1/employees/me">https://icehrm.com/api/test1/employees/me</a></li>
                        </ul>
                        <p>You can use the following request by changing API URL and auth token.</p>
                        <pre class="wp-block-code"><code>curl -i https://icehrm.com/api/test1/employees/me \
  -H "Authorization: Bearer RRRRRRRR6fdeb20bb04b2c23DDDDD"</code></pre>
                        <p>For creating an employee you can use</p>
                        <pre class="wp-block-code"><code>curl -X POST -H "Authorization: Bearer 9RRRRRRRR6fdeb20bb04b2c23DDDDD" -H "Content-Type: application/json" -d '{
  "employee_id": "D101",
  ...
  "work_email": "<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="573e34323f253a7c36333a3e39172032357a2423363b3c7934383a">[email&#160;protected]</a>",
  "private_email": "<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="fb92989e938996d09a9f969295bb8c9e99d6888f9a9790d5989496">[email&#160;protected]</a>",
  ...
  "approver2": "6",
  "approver3": "7"
}' "https://icehrm.com/api/test1/employees"</code></pre>
                    </div>
                </div>
                ...
                <div class="docs-navigation"><a href="https://icehrm.com/explore/docs/sign-in-with-saml-okta/" rel="prev"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
                        ...
                        </svg> Sign-In with SAML (Okta)</a></div>
