    ...
    <div class="betterdocs-single-wraper betterdocs-single-bg betterdocs-single-layout1">
        ...
        <div class="betterdocs-content-area">
            ...
            <div id="betterdocs-single-main" class="docs-single-main">
                    ...
                    <div class="docs-single-title">
                        <nav id="betterdocs-breadcrumb" class="betterdocs-breadcrumb" xmlns:v="http://rdf.data-vocabulary.org/#">
                            <ul class="betterdocs-breadcrumb-list">
                                ...
                                <li class="betterdocs-breadcrumb-item item-current item-2760 current"><span>Understanding User Levels</span></li>
                            </ul>
                        </nav>
                        <h1 id="betterdocs-entry-title" class="betterdocs-entry-title">Understanding User Levels</h1>
                    </div>
                </header>
                <div class="betterdocs-entry-content">
                    ...
                    <div class="betterdocs-toc toc-list-number">
                        ...
                        <ul class="toc-list betterdocs-hierarchial-toc">
                            <li class="betterdocs-toc-heading-level-2"><a href="#0-toc-title">Use of Restricted User levels</a></li>
                        </ul>
                    </div>
                    <div id="betterdocs-single-content" class="betterdocs-content">
                        ...
                        <p>For example, under the leave module, a manager can see their subordinates&#8217; leave days, can approve leaves, and grant leaves. But as an admin, you can see leave requests from all the employees and act on these requests.</p>
                        ...
                        <ol>
                            ...
                            <li>You can select the employee you want to make changes to and click on the edit button.</li>
                        </ol>
                        <figure class="wp-block-image size-full"><img decoding="async" width="900" height="500" src="https://icehrm.com/explore/wp-content/uploads/2022/10/Untitled-design-100.png" alt="" class="wp-image-2761" srcset="https://icehrm.com/explore/wp-content/uploads/2022/10/Untitled-design-100.png 900w, https://icehrm.com/explore/wp-content/uploads/2022/10/Untitled-design-100-300x167.png 300w, https://icehrm.com/explore/wp-content/uploads/2022/10/Untitled-design-100-768x427.png 768w, https://icehrm.com/explore/wp-content/uploads/2022/10/Untitled-design-100-600x333.png 600w" sizes="(max-width: 900px) 100vw, 900px" /></figure>
                        <p>5. Now you can change the User Level of the employee to Admin.</p>
                        <figure class="wp-block-image size-full"><img decoding="async" loading="lazy" width="900" height="300" src="https://icehrm.com/explore/wp-content/uploads/2022/10/Untitled-900-×-300px-36.png" alt="" class="wp-image-2762" srcset="https://icehrm.com/explore/wp-content/uploads/2022/10/Untitled-900-×-300px-36.png 900w, https://icehrm.com/explore/wp-content/uploads/2022/10/Untitled-900-×-300px-36-300x100.png 300w, https://icehrm.com/explore/wp-content/uploads/2022/10/Untitled-900-×-300px-36-768x256.png 768w, https://icehrm.com/explore/wp-content/uploads/2022/10/Untitled-900-×-300px-36-600x200.png 600w" sizes="(max-width: 900px) 100vw, 900px" /></figure>
                        ...
                        <h2 id="0-toc-title" class="betterdocs-content-heading" id="0-toc-title">Use of Restricted User levels <a href="#0-toc-title" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/understanding-user-levels/#0-toc-title" data-title="Copy URL">#</a></h2>
                ...
                <div class="docs-navigation"><a href="https://icehrm.com/explore/docs/finding-problems-when-a-data-import-fail/" rel="prev"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
                        ...
                        </svg> Finding Problems When a Data Import Fail</a><a href="https://icehrm.com/explore/docs/adding-a-restricted-recruitment-manager/" rel="next">Adding a Restricted Recruitment Manager <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
