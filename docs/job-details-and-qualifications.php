            ...
            <div id="betterdocs-single-main" class="docs-single-main">
                    ...
                    <div class="docs-single-title">
                        <nav id="betterdocs-breadcrumb" class="betterdocs-breadcrumb" xmlns:v="http://rdf.data-vocabulary.org/#">
                            <ul class="betterdocs-breadcrumb-list">
                                ...
                                <li class="betterdocs-breadcrumb-item item-current item-2711 current"><span>Job Details and Qualifications Set Up</span></li>
                            </ul>
                        </nav>
                        <h1 id="betterdocs-entry-title" class="betterdocs-entry-title">Job Details and Qualifications Set Up</h1>
                    </div>
                </header>
                <div class="betterdocs-entry-content">
                    ...
                    <div id="betterdocs-single-content" class="betterdocs-content">
                        <h2 id="job-details-setup" class="betterdocs-content-heading" id="job-details-setup">Job Details Setup <a href="#job-details-setup" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/job-details-and-qualifications-set-up/#job-details-setup" data-title="Copy URL">#</a></h2>
                        ...
                        <h2 id="qualifications-setup" class="betterdocs-content-heading" id="qualifications-setup">Qualifications Setup <a href="#qualifications-setup" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/job-details-and-qualifications-set-up/#qualifications-setup" data-title="Copy URL">#</a></h2>
                ...
                <div class="docs-navigation"><a href="https://icehrm.com/explore/docs/employee-history/" rel="prev"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
                        ...
                        </svg> Employee History</a><a href="https://icehrm.com/explore/docs/preparing-employee-data-for-upload/" rel="next">Preparing Employee Data For Upload <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
