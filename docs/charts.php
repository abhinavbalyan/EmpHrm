                    ...
                    <div class="docs-single-title">
                        <nav id="betterdocs-breadcrumb" class="betterdocs-breadcrumb" xmlns:v="http://rdf.data-vocabulary.org/#">
                            <ul class="betterdocs-breadcrumb-list">
                                ...
                                <li class="betterdocs-breadcrumb-item"><a href="https://icehrm.com/explore/docs-category/insights/">Insights</a></li>
                                <li class="betterdocs-breadcrumb-item breadcrumb-delimiter">
                                    <div class="icon-container"><svg class="breadcrumb-delimiter-icon" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="angle-right" class="svg-inline--fa fa-angle-right fa-w-8" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 512">
                                            <path fill="currentColor" d="M224.3 273l-136 136c-9.4 9.4-24.6 9.4-33.9 0l-22.6-22.6c-9.4-9.4-9.4-24.6 0-33.9l96.4-96.4-96.4-96.4c-9.4-9.4-9.4-24.6 0-33.9L54.3 103c9.4-9.4 24.6-9.4 33.9 0l136 136c9.5 9.4 9.5 24.6.1 34z"></path>
                                        </svg>
                                ...
                                <li class="betterdocs-breadcrumb-item item-current item-1169 current"><span>Charts</span></li>
                            </ul>
                        </nav>
                        <h1 id="betterdocs-entry-title" class="betterdocs-entry-title">Charts</h1>
                    </div>
                </header>
                <div class="betterdocs-entry-content">
                    ...
                    <div class="betterdocs-toc toc-list-number">
                        ...
                        <ul class="toc-list betterdocs-hierarchial-toc">
                            <li class="betterdocs-toc-heading-level-1"><a href="#attendance-graph">Attendance Graph</a></li>
                            <li class="betterdocs-toc-heading-level-1"><a href="#attendance-vs-timesheets-graph">Attendance vs Timesheets Graph</a></li>
                            <li class="betterdocs-toc-heading-level-1"><a href="#leave-timeline">Leave Timeline</a></li>
                        </ul>
                    </div>
                    <div id="betterdocs-single-content" class="betterdocs-content">
                        <p>Attendance Monitoring charts are very useful when you when to get a quick abstract look at how all the employees or a specific employee attend to their work. It shows how much time they spend time in the office against how much time they actually put into timesheets.</p>
                        <h1 id="attendance-graph" class="betterdocs-content-heading" id="attendance-graph">Attendance Graph <a href="#attendance-graph" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/charts/#attendance-graph" data-title="Copy URL">#</a></h1>
                        <p>Here you can check attendance time recorded every day for all the employees or a specific employee.</p>
                        <figure class="wp-block-image"><img decoding="async" src="https://icehrm.s3.amazonaws.com/images/blog-images/attendance_graph.png" alt="" />
                            <figcaption>Attendance graph</figcaption>
                        </figure>
                        <p></p>
                        <h1 id="attendance-vs-timesheets-graph" class="betterdocs-content-heading" id="attendance-vs-timesheets-graph">Attendance vs Timesheets Graph <a href="#attendance-vs-timesheets-graph" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/charts/#attendance-vs-timesheets-graph" data-title="Copy URL">#</a></h1>
                        <p>In this chart, admins/managers can see how much of a percentage of attendance time goes into timesheets for each employee.</p>
                        <figure class="wp-block-image"><img decoding="async" src="https://icehrm.s3.amazonaws.com/images/blog-images/hours_in_office_vs_timesheets.png" alt="" />
                            <figcaption>Attendance vs Time sheet graph</figcaption>
                        </figure>
                        <h1 id="leave-timeline" class="betterdocs-content-heading" id="leave-timeline">Leave Timeline <a href="#leave-timeline" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/charts/#leave-timeline" data-title="Copy URL">#</a></h1>
                        <p>Here, you can view approved employee leaves of employees with the leave dates.</p>
                        <figure class="wp-block-image size-large"><img decoding="async" loading="lazy" width="1024" height="367" src="https://icehrm.com/explore/wp-content/uploads/2022/02/Screenshot-from-2022-02-14-09-48-27-1-1024x367.png" alt="" class="wp-image-1889" srcset="https://icehrm.com/explore/wp-content/uploads/2022/02/Screenshot-from-2022-02-14-09-48-27-1-1024x367.png 1024w, https://icehrm.com/explore/wp-content/uploads/2022/02/Screenshot-from-2022-02-14-09-48-27-1-300x108.png 300w, https://icehrm.com/explore/wp-content/uploads/2022/02/Screenshot-from-2022-02-14-09-48-27-1-768x276.png 768w, https://icehrm.com/explore/wp-content/uploads/2022/02/Screenshot-from-2022-02-14-09-48-27-1-1536x551.png 1536w, https://icehrm.com/explore/wp-content/uploads/2022/02/Screenshot-from-2022-02-14-09-48-27-1-600x215.png 600w, https://icehrm.com/explore/wp-content/uploads/2022/02/Screenshot-from-2022-02-14-09-48-27-1.png 1658w" sizes="(max-width: 1024px) 100vw, 1024px" /></figure>
                        <p></p>
                    </div>
                </div>
                <div class="betterdocs-entry-footer">
                    <div class="feedback-update-form">
                        ...
                        <div class="update-date">
                            Updated on February 14, 2022 </div>
                    </div>
                </div>
                <div class="docs-navigation"><a href="https://icehrm.com/explore/docs/reporting/" rel="next">Reporting <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
