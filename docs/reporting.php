    ...
    <div class="betterdocs-single-wraper betterdocs-single-bg betterdocs-single-layout1">
        ...
        <div class="betterdocs-content-area">
            ...
            <div id="betterdocs-single-main" class="docs-single-main">
                    ...
                    <div class="docs-single-title">
                        <nav id="betterdocs-breadcrumb" class="betterdocs-breadcrumb" xmlns:v="http://rdf.data-vocabulary.org/#">
                            <ul class="betterdocs-breadcrumb-list">
                                ...
                                <li class="betterdocs-breadcrumb-item item-current item-1171 current"><span>Reporting</span></li>
                            </ul>
                        </nav>
                        <h1 id="betterdocs-entry-title" class="betterdocs-entry-title">Reporting</h1>
                    </div>
                </header>
                <div class="betterdocs-entry-content">
                    ...
                    <div class="betterdocs-toc toc-list-number">
                        ...
                        <ul class="toc-list betterdocs-hierarchial-toc">
                            <li class="betterdocs-toc-heading-level-1"><a href="#admin-reports">Admin Reports</a></li>
                            <li class="betterdocs-toc-heading-level-1"><a href="#user-reports">User Reports</a></li>
                        </ul>
                    </div>
                    <div id="betterdocs-single-content" class="betterdocs-content">
                        <h1 id="admin-reports" class="betterdocs-content-heading" id="admin-reports">Admin Reports <a href="#admin-reports" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/reporting/#admin-reports" data-title="Copy URL">#</a></h1>
                        <p><em><strong>(Admin Reports -> Reports)</strong></em>I</p>
                        <p>IceHrm saves all the generated reports under the <strong>Report files</strong> section for future references. Admins are entitled to generate the following reports.</p>
                        <figure class="wp-block-image"><img decoding="async" src="https://files.gitbook.com/v0/b/gitbook-28427.appspot.com/o/assets%2F-LSTAqbcVhk-wxBWPiuv%2F-LSTBj3Mn8gXVQaLg9Zr%2F-LSTBjsHn_6bXH3Ukwfb%2Fadmin_reports.png?generation=1543473660549816&amp;alt=media" alt="" /></figure>
                        <h1 id="user-reports" class="betterdocs-content-heading" id="user-reports">User Reports <a href="#user-reports" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/reporting/#user-reports" data-title="Copy URL">#</a></h1>
                        <p><em><strong>(User Reports -> Reports)</strong></em></p>
                        <p>Following reports can be downloaded by employees.</p>
                        <figure class="wp-block-image size-full"><img decoding="async" loading="lazy" width="990" height="442" src="https://icehrm.com/explore/wp-content/uploads/2021/11/empreport.png" alt="" class="wp-image-1172" srcset="https://icehrm.com/explore/wp-content/uploads/2021/11/empreport.png 990w, https://icehrm.com/explore/wp-content/uploads/2021/11/empreport-300x134.png 300w, https://icehrm.com/explore/wp-content/uploads/2021/11/empreport-768x343.png 768w, https://icehrm.com/explore/wp-content/uploads/2021/11/empreport-600x268.png 600w" sizes="(max-width: 990px) 100vw, 990px" /></figure>
                    </div>
                </div>
                ...
                <div class="docs-navigation"><a href="https://icehrm.com/explore/docs/charts/" rel="prev"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
                        ...
                        </svg> Charts</a><a href="https://icehrm.com/explore/docs/company-assets/" rel="next">Company Assets <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
