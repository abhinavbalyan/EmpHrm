            ...
            <div id="betterdocs-single-main" class="docs-single-main">
                    ...
                    <div class="docs-single-title">
                        <nav id="betterdocs-breadcrumb" class="betterdocs-breadcrumb" xmlns:v="http://rdf.data-vocabulary.org/#">
                            <ul class="betterdocs-breadcrumb-list">
                                ...
                                <li class="betterdocs-breadcrumb-item item-current item-2748 current"><span>Finding Problems When a Data Import Fail</span></li>
                            </ul>
                        </nav>
                        <h1 id="betterdocs-entry-title" class="betterdocs-entry-title">Finding Problems When a Data Import Fail</h1>
                    </div>
                </header>
                <div class="betterdocs-entry-content">
                    ...
                    <div id="betterdocs-single-content" class="betterdocs-content">
                        <p>If you have failed to import a file to IceHrm, you can find out what went wrong. You will get an error message once you click on the process button if your data file is wrong.</p>
                        <figure class="wp-block-image size-full"><img decoding="async" width="900" height="500" src="https://icehrm.com/explore/wp-content/uploads/2022/10/Untitled-design-99.png" alt="" class="wp-image-2749" srcset="https://icehrm.com/explore/wp-content/uploads/2022/10/Untitled-design-99.png 900w, https://icehrm.com/explore/wp-content/uploads/2022/10/Untitled-design-99-300x167.png 300w, https://icehrm.com/explore/wp-content/uploads/2022/10/Untitled-design-99-768x427.png 768w, https://icehrm.com/explore/wp-content/uploads/2022/10/Untitled-design-99-600x333.png 600w" sizes="(max-width: 900px) 100vw, 900px" /></figure>
                        <p>Click on the OK button and then click on the Edit button to check the error.</p>
                        <figure class="wp-block-image size-full"><img decoding="async" loading="lazy" width="900" height="300" src="https://icehrm.com/explore/wp-content/uploads/2022/10/Untitled-900-×-300px-35.png" alt="" class="wp-image-2750" srcset="https://icehrm.com/explore/wp-content/uploads/2022/10/Untitled-900-×-300px-35.png 900w, https://icehrm.com/explore/wp-content/uploads/2022/10/Untitled-900-×-300px-35-300x100.png 300w, https://icehrm.com/explore/wp-content/uploads/2022/10/Untitled-900-×-300px-35-768x256.png 768w, https://icehrm.com/explore/wp-content/uploads/2022/10/Untitled-900-×-300px-35-600x200.png 600w" sizes="(max-width: 900px) 100vw, 900px" /></figure>
                        ...
                        <p><a href="https://icehrm.com/explore/docs/employee-data-import/#betterdocs-form-modal"></a></p>
                    </div>
                </div>
                ...
                <div class="docs-navigation"><a href="https://icehrm.com/explore/docs/creating-data-importers/" rel="prev"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
                        ...
                        </svg> Creating Data Importers</a><a href="https://icehrm.com/explore/docs/understanding-user-levels/" rel="next">Understanding User Levels <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
