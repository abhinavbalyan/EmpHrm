            ...
            <div id="betterdocs-single-main" class="docs-single-main">
                    ...
                    <div class="docs-single-title">
                        <nav id="betterdocs-breadcrumb" class="betterdocs-breadcrumb" xmlns:v="http://rdf.data-vocabulary.org/#">
                            <ul class="betterdocs-breadcrumb-list">
                                ...
                                <li class="betterdocs-breadcrumb-item item-current item-2475 current"><span>Creating a Travel Request As an Employee</span></li>
                            </ul>
                        </nav>
                        <h1 id="betterdocs-entry-title" class="betterdocs-entry-title">Creating a Travel Request As an Employee</h1>
                    </div>
                </header>
                <div class="betterdocs-entry-content">
                    ...
                    <div id="betterdocs-single-content" class="betterdocs-content">
                        ...
                        <figure class="wp-block-image size-full"><img decoding="async" width="900" height="500" src="https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-48.png" alt="" class="wp-image-2476" srcset="https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-48.png 900w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-48-300x167.png 300w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-48-768x427.png 768w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-48-600x333.png 600w" sizes="(max-width: 900px) 100vw, 900px" /></figure>
                ...
                <div class="docs-navigation"><a href="https://icehrm.com/explore/docs/travel-module/" rel="prev"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
                        ...
                        </svg> Travel Module</a><a href="https://icehrm.com/explore/docs/assigning-a-travel-request-as-an-admin-manager/" rel="next">Assigning a Travel Request As an Admin/Manager <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
