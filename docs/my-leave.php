    ...
    <div class="betterdocs-single-wraper betterdocs-single-bg betterdocs-single-layout1">
        ...
        <div class="betterdocs-content-area">
            ...
            <div id="betterdocs-single-main" class="docs-single-main">
                    ...
                    <div class="docs-single-title">
                        <nav id="betterdocs-breadcrumb" class="betterdocs-breadcrumb" xmlns:v="http://rdf.data-vocabulary.org/#">
                            <ul class="betterdocs-breadcrumb-list">
                                ...
                                <li class="betterdocs-breadcrumb-item item-current item-1190 current"><span>My Leave</span></li>
                            </ul>
                        </nav>
                        <h1 id="betterdocs-entry-title" class="betterdocs-entry-title">My Leave</h1>
                    </div>
                </header>
                <div class="betterdocs-entry-content">
                    ...
                    <div class="betterdocs-toc toc-list-number">
                        ...
                        <ul class="toc-list betterdocs-hierarchial-toc">
                            <li class="betterdocs-toc-heading-level-2"><a href="#how-to-check-the-leave-status-using-the-icehrm-mobile-app">How to check the leave status using the IceHrm mobile App?</a></li>
                        </ul>
                    </div>
                    <div id="betterdocs-single-content" class="betterdocs-content">
                        <p>Using IceHrm mobile app, employees can check their leave status under each Leave types.</p>
                        <p>Let employees apply for days off, directly via mobile. They can view the approved leaves, pending leaves, and the dates of the leaves.</p>
                        <h2 id="how-to-check-the-leave-status-using-the-icehrm-mobile-app" class="betterdocs-content-heading" id="how-to-check-the-leave-status-using-the-icehrm-mobile-app">How to check the leave status using the IceHrm mobile App? <a href="#how-to-check-the-leave-status-using-the-icehrm-mobile-app" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/my-leave/#how-to-check-the-leave-status-using-the-icehrm-mobile-app" data-title="Copy URL">#</a></h2>
                        <ol>
                            <li>Log in to the mobile app and click on the My Leave option</li>
                            <li>Employees can find out the status of their requested leaves as <strong>Pending</strong> Leaves, <strong>Approved </strong>Leaves or <strong>Cancelled </strong>Leaves. Also, the app shows the leave requested dates.</li>
                        </ol>
                        <figure class="wp-block-image size-large"><img decoding="async" width="473" height="1024" src="https://icehrm.com/explore/wp-content/uploads/2021/11/mob1-473x1024.png" alt="" class="wp-image-1191" srcset="https://icehrm.com/explore/wp-content/uploads/2021/11/mob1-473x1024.png 473w, https://icehrm.com/explore/wp-content/uploads/2021/11/mob1-139x300.png 139w, https://icehrm.com/explore/wp-content/uploads/2021/11/mob1-768x1662.png 768w, https://icehrm.com/explore/wp-content/uploads/2021/11/mob1-710x1536.png 710w, https://icehrm.com/explore/wp-content/uploads/2021/11/mob1-600x1299.png 600w, https://icehrm.com/explore/wp-content/uploads/2021/11/mob1.png 828w" sizes="(max-width: 473px) 100vw, 473px" /></figure>
                        <p></p>
                        <figure class="wp-block-image size-large"><img decoding="async" loading="lazy" width="473" height="1024" src="https://icehrm.com/explore/wp-content/uploads/2021/11/mob2-473x1024.png" alt="" class="wp-image-1192" srcset="https://icehrm.com/explore/wp-content/uploads/2021/11/mob2-473x1024.png 473w, https://icehrm.com/explore/wp-content/uploads/2021/11/mob2-139x300.png 139w, https://icehrm.com/explore/wp-content/uploads/2021/11/mob2-768x1662.png 768w, https://icehrm.com/explore/wp-content/uploads/2021/11/mob2-710x1536.png 710w, https://icehrm.com/explore/wp-content/uploads/2021/11/mob2-600x1299.png 600w, https://icehrm.com/explore/wp-content/uploads/2021/11/mob2.png 828w" sizes="(max-width: 473px) 100vw, 473px" /></figure>
                        <p></p>
                        <p></p>
                    </div>
                </div>
                ...
                <div class="docs-navigation"><a href="https://icehrm.com/explore/docs/attendance-tracking/" rel="prev"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
