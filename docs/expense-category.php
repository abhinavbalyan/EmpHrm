    ...
    <div class="betterdocs-single-wraper betterdocs-single-bg betterdocs-single-layout1">
        ...
        <div class="betterdocs-content-area">
            ...
            <div id="betterdocs-single-main" class="docs-single-main">
                    ...
                    <div class="docs-single-title">
                        <nav id="betterdocs-breadcrumb" class="betterdocs-breadcrumb" xmlns:v="http://rdf.data-vocabulary.org/#">
                            <ul class="betterdocs-breadcrumb-list">
                                ...
                                <li class="betterdocs-breadcrumb-item item-current item-2491 current"><span>Adding an Expense Category</span></li>
                            </ul>
                        </nav>
                        <h1 id="betterdocs-entry-title" class="betterdocs-entry-title">Adding an Expense Category</h1>
                    </div>
                </header>
                <div class="betterdocs-entry-content">
                    ...
                    <div id="betterdocs-single-content" class="betterdocs-content">
                        ...
                        <ol>
                            ...
                            <li>In <a href="https://icehrm.com/">IceHrm</a> we have already defined some expense categories which are in the use in the Industry. If you want to add anything else, you can click on the Add New option under the Expense Categories tab.</li>
                            <li>Then add a meaningful full <strong>Name</strong> to the expense and <strong>Save</strong>.</li>
                        </ol>
                        <figure class="wp-block-image size-full"><img decoding="async" width="900" height="500" src="https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-53.png" alt="" class="wp-image-2492" srcset="https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-53.png 900w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-53-300x167.png 300w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-53-768x427.png 768w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-53-600x333.png 600w" sizes="(max-width: 900px) 100vw, 900px" /></figure>
                    </div>
                </div>
                ...
                <div class="docs-navigation"><a href="https://icehrm.com/explore/docs/adding-expenses/" rel="prev"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
                        ...
                        </svg> Adding Expenses</a><a href="https://icehrm.com/explore/docs/enabling-multilevel-approval-for-an-employee-expense/" rel="next">Enabling Multilevel Approval For an Employee Expense <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
