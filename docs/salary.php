    ...
    <div class="betterdocs-single-wraper betterdocs-single-bg betterdocs-single-layout1">
        ...
        <div class="betterdocs-content-area">
            ...
            <div id="betterdocs-single-main" class="docs-single-main">
                    ...
                    <div class="docs-single-title">
                        <nav id="betterdocs-breadcrumb" class="betterdocs-breadcrumb" xmlns:v="http://rdf.data-vocabulary.org/#">
                            <ul class="betterdocs-breadcrumb-list">
                                ...
                                <li class="betterdocs-breadcrumb-item item-current item-1157 current"><span>Salary</span></li>
                            </ul>
                        </nav>
                        <h1 id="betterdocs-entry-title" class="betterdocs-entry-title">Salary</h1>
                    </div>
                </header>
                <div class="betterdocs-entry-content">
                    ...
                    <div class="betterdocs-toc toc-list-number">
                        ...
                        <ul class="toc-list betterdocs-hierarchial-toc">
                            <li class="betterdocs-toc-heading-level-1"><a href="#defining-employee-salary-details">Defining Employee Salary Details</a>
                                <ul class="betterdocs-toc-list-level-2">
                                    <li class="betterdocs-toc-heading-level-2"><a href="#salary-component-types">Salary Component Types</a></li>
                                    <li class="betterdocs-toc-heading-level-2"><a href="#salary-component">Salary Component</a></li>
                                    <li class="betterdocs-toc-heading-level-2"><a href="#employee-salary">Employee Salary</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
                    <div id="betterdocs-single-content" class="betterdocs-content">
                        <h1 id="defining-employee-salary-details" class="betterdocs-content-heading" id="defining-employee-salary-details">Defining Employee Salary Details <a href="#defining-employee-salary-details" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/salary/#defining-employee-salary-details" data-title="Copy URL">#</a></h1>
                        <p>Using the IceHrm <strong>Payroll -> Salary</strong> section, you can add employees&#8217; salary details. You need to enter the salary details under this section so when you generate the payroll report, the system will automatically generate and calculate the data. We have three sections to do this:</p>
                        <ul>
                            <li>Salary Component Types</li>
                            <li>Salary Component</li>
                            <li>Employee Salary</li>
                        </ul>
                        <h2 id="salary-component-types" class="betterdocs-content-heading" id="salary-component-types">Salary Component Types <a href="#salary-component-types" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/salary/#salary-component-types" data-title="Copy URL">#</a></h2>
                        <p>First, you can define the Salary Component Types according to your organization&#8217;s payroll requirements. </p>
                        <p>Example: If the salary component is Car Allowance, you need to create a salary component type for Allowance.</p>
                        <figure class="wp-block-image"><img decoding="async" src="https://files.gitbook.com/v0/b/gitbook-28427.appspot.com/o/assets%2F-LSTAqbcVhk-wxBWPiuv%2F-MXf_eUXpr4WMKemTArz%2F-MXg1WDPy7IJ5SZ_zzMb%2Fimage.png?alt=media&amp;token=609811b6-9434-40db-b057-122daf98d53b" alt="" /></figure>
                        <h2 id="salary-component" class="betterdocs-content-heading" id="salary-component">Salary Component <a href="#salary-component" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/salary/#salary-component" data-title="Copy URL">#</a></h2>
                        <p>Using salary components you can define all the component categories. </p>
                        <p>Example: For the Allowance Salary Component Type, you can create allowances categories like Car Allowance, Telephone Allowance, Laptop Allowance, or Internet Allowance according to your company requirements.</p>
                        <figure class="wp-block-image"><img decoding="async" src="https://files.gitbook.com/v0/b/gitbook-28427.appspot.com/o/assets%2F-LSTAqbcVhk-wxBWPiuv%2F-MXf_eUXpr4WMKemTArz%2F-MXg43C0JvUiv3C-BnSp%2Fimage.png?alt=media&amp;token=ae1f91ad-986c-4f66-8fa1-d609f97f390c" alt="" /></figure>
                        <h2 id="employee-salary" class="betterdocs-content-heading" id="employee-salary">Employee Salary <a href="#employee-salary" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/salary/#employee-salary" data-title="Copy URL">#</a></h2>
                        <p>Once you finish adding the salary components, now you can enter the salary details of each of your employees.</p>
                        <figure class="wp-block-image size-large"><img decoding="async" loading="lazy" width="1024" height="424" src="https://icehrm.com/explore/wp-content/uploads/2021/11/saldetails-1024x424.png" alt="" class="wp-image-1158" srcset="https://icehrm.com/explore/wp-content/uploads/2021/11/saldetails-1024x424.png 1024w, https://icehrm.com/explore/wp-content/uploads/2021/11/saldetails-300x124.png 300w, https://icehrm.com/explore/wp-content/uploads/2021/11/saldetails-768x318.png 768w, https://icehrm.com/explore/wp-content/uploads/2021/11/saldetails-1536x635.png 1536w, https://icehrm.com/explore/wp-content/uploads/2021/11/saldetails-600x248.png 600w, https://icehrm.com/explore/wp-content/uploads/2021/11/saldetails.png 1893w" sizes="(max-width: 1024px) 100vw, 1024px" /></figure>
                    </div>
                </div>
                ...
                <div class="docs-navigation"><a href="https://icehrm.com/explore/docs/payroll-management/" rel="next">Payroll Management <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
