            ...
            <div id="betterdocs-single-main" class="docs-single-main">
                    ...
                    <div class="docs-single-title">
                        <nav id="betterdocs-breadcrumb" class="betterdocs-breadcrumb" xmlns:v="http://rdf.data-vocabulary.org/#">
                            <ul class="betterdocs-breadcrumb-list">
                                ...
                                <li class="betterdocs-breadcrumb-item item-current item-2494 current"><span>Enabling Multilevel Approval For an Employee Expense</span></li>
                            </ul>
                        </nav>
                        <h1 id="betterdocs-entry-title" class="betterdocs-entry-title">Enabling Multilevel Approval For an Employee Expense</h1>
                    </div>
                </header>
                <div class="betterdocs-entry-content">
                    ...
                    <div id="betterdocs-single-content" class="betterdocs-content">
                        <h1 id="approval-process" class="betterdocs-content-heading" id="approval-process">Approval Process <a href="#approval-process" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/enabling-multilevel-approval-for-an-employee-expense/#approval-process" data-title="Copy URL">#</a></h1>
                        ...
                        <h2 id="how-to-enable-multilevel-approval-for-an-employee-expense" class="betterdocs-content-heading" id="how-to-enable-multilevel-approval-for-an-employee-expense">How to enable multilevel approval for an employee expense? <a href="#how-to-enable-multilevel-approval-for-an-employee-expense" class="anchor" data-clipboard-text="https://icehrm.com/explore/docs/enabling-multilevel-approval-for-an-employee-expense/#how-to-enable-multilevel-approval-for-an-employee-expense" data-title="Copy URL">#</a></h2>
                        ...
                        <ol>
                            ...
                            <li>Click on the <strong>Other</strong> tab</li>
                        ...
                        <figure class="wp-block-image size-full"><img decoding="async" loading="lazy" width="900" height="300" src="https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-900-×-300px-8.png" alt="" class="wp-image-2495" srcset="https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-900-×-300px-8.png 900w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-900-×-300px-8-300x100.png 300w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-900-×-300px-8-768x256.png 768w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-900-×-300px-8-600x200.png 600w" sizes="(max-width: 900px) 100vw, 900px" /></figure>
                    </div>
                </div>
                ...
                <div class="docs-navigation"><a href="https://icehrm.com/explore/docs/adding-an-expense-category/" rel="prev"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
                        ...
                        </svg> Adding an Expense Category</a><a href="https://icehrm.com/explore/docs/approving-an-expense-as-an-admin-manager/" rel="next">Approving an Expense As an Admin/Manager <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
