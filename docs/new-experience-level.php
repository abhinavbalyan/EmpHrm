    ...
    <div class="betterdocs-single-wraper betterdocs-single-bg betterdocs-single-layout1">
        ...
        <div class="betterdocs-content-area">
            ...
            <div id="betterdocs-single-main" class="docs-single-main">
                    ...
                    <div class="docs-single-title">
                        <nav id="betterdocs-breadcrumb" class="betterdocs-breadcrumb" xmlns:v="http://rdf.data-vocabulary.org/#">
                            <ul class="betterdocs-breadcrumb-list">
                                ...
                                <li class="betterdocs-breadcrumb-item item-current item-2427 current"><span>Adding a New Experience Level</span></li>
                            </ul>
                        </nav>
                        <h1 id="betterdocs-entry-title" class="betterdocs-entry-title">Adding a New Experience Level</h1>
                    </div>
                </header>
                <div class="betterdocs-entry-content">
                    ...
                    <div id="betterdocs-single-content" class="betterdocs-content">
                        <ol>
                            ...
                            <li>Under the recruitment module, Click to Recruitment set up</li>
                            <li>Go to the Edit Experience Levels tab and click on to the Add New Icon</li>
                            <li>Then give a meaningful name and Save</li>
                        </ol>
                        <figure class="wp-block-image size-full"><img decoding="async" width="900" height="500" src="https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-33.png" alt="" class="wp-image-2428" srcset="https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-33.png 900w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-33-300x167.png 300w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-33-768x427.png 768w, https://icehrm.com/explore/wp-content/uploads/2022/09/Untitled-design-33-600x333.png 600w" sizes="(max-width: 900px) 100vw, 900px" /></figure>
                    </div>
                </div>
                ...
                <div class="docs-navigation"><a href="https://icehrm.com/explore/docs/adding-a-new-employment-type/" rel="prev"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
                        ...
                        </svg> Adding a New Employment Type</a><a href="https://icehrm.com/explore/docs/adding-and-editing-a-new-job-function/" rel="next">Adding And Editing a New Job Function <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
