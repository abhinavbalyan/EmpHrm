            ...
            <div id="betterdocs-single-main" class="docs-single-main">
                    ...
                    <div class="docs-single-title">
                        <nav id="betterdocs-breadcrumb" class="betterdocs-breadcrumb" xmlns:v="http://rdf.data-vocabulary.org/#">
                            <ul class="betterdocs-breadcrumb-list">
                                ...
                                <li class="betterdocs-breadcrumb-item item-current item-2716 current"><span>Preparing Employee Data For Upload</span></li>
                            </ul>
                        </nav>
                        <h1 id="betterdocs-entry-title" class="betterdocs-entry-title">Preparing Employee Data For Upload</h1>
                    </div>
                </header>
                <div class="betterdocs-entry-content">
                    ...
                    <div id="betterdocs-single-content" class="betterdocs-content">
                        ...
                        <ul>
                            <li>employee_id = The id of the employee (this id should be unique, if the employee with the same id exists in the system then employee details will be replaced)</li>
                ...
                <div class="docs-navigation"><a href="https://icehrm.com/explore/docs/job-details-and-qualifications-set-up/" rel="prev"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
                        ...
                        </svg> Job Details and Qualifications Set Up</a><a href="https://icehrm.com/explore/docs/importing-basic-employee-data/" rel="next">Importing Basic Employee Data <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="42px" viewBox="0 0 50 50" version="1.1">
                            <g id="surface1">
